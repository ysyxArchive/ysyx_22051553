...
object ControlUnit {    //译码特征, 类型、需要做哪些任务
    ...
    val map = Array(
        ...
        LB -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LB),
        LH -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LH),
        LW -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LW),
        LBU -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LBU),
        LHU -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LHU),
        LWU -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LWU),
        LD -> List(NO_JUMP, NO_BR, A_REG1, B_IMM, IMM_I, ALU_ADD, WB_MEM, SD_NO, LD_LD),
