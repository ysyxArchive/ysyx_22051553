...
object ControlUnit {    //译码特征, 类型、需要做哪些任务
    ...
    val map = Array(
        ...
        BEQ -> List(NO_JUMP, BR_ANY, A_REG1, B_REG2, IMM_B, ALU_EQU, WB_NO, SD_NO, LD_NO),
        BNE -> List(NO_JUMP, BR_ANY, A_REG1, B_REG2, IMM_B, ALU_NEQ, WB_NO, SD_NO, LD_NO),
        BLT -> List(NO_JUMP, BR_ANY, A_REG1, B_REG2, IMM_B, ALU_SLT, WB_NO, SD_NO, LD_NO),
        BGE -> List(NO_JUMP, BR_ANY, A_REG1, B_REG2, IMM_B, ALU_SGE, WB_NO, SD_NO, LD_NO),
        BLTU -> List(NO_JUMP, BR_ANY, A_REG1, B_REG2, IMM_B, ALU_SLTU, WB_NO, SD_NO, LD_NO),
        BGEU -> List(NO_JUMP, BR_ANY, A_REG1, B_REG2, IMM_B, ALU_SGEU, WB_NO, SD_NO, LD_NO),
