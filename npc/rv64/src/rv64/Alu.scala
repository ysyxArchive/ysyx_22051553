...
class Alu extends Module {
    ...
    io.result := MuxLookup(
        ...
        Seq(
            ...
            ALU_EQU -> (io.op_a === io.op_b),
            ALU_NEQ -> (io.op_a =/= io.op_b),
            ALU_SLT -> (io.op_a.asSInt < io.op_b.asSInt),
            ALU_SGE -> (io.op_a.asSInt > io.op_b.asSInt),
            ALU_SLTU -> (io.op_a < io.op_b),
            ALU_SGEU -> (io.op_a > io.op_b),
            ...
            ALU_MUL -> ((long_as * long_bs)(63,0)),
            ALU_MULH -> ((long_as * long_bs)(127,64)),
            ALU_MULHSU -> ((long_as * long_bu)(127,64)),
            ALU_MULHU -> ((long_au * long_bu)(127,64)),
