...
module Decode(	// <stdin>:948:10
  ...
  assign io_deio_op_a = (&_cu_io_opa_type) ? _eximm_io_eximm : _io_deio_op_a_T_3 ? _io_jump_pc_T_4 : {32'h0,
                _cu_io_opa_type == 2'h1 ? io_fdio_pc : 32'h0};	// <stdin>:948:10, Decode.scala:53:20, :54:23, :77:34, :98:38, Mux.scala:81:{58,61}
  assign io_deio_op_b = _cu_io_opb_type == 3'h4 ? _io_deio_csr_t_T : _cu_io_opb_type == 3'h3 ? 64'h4 :
                ...
                64'h0;	// <stdin>:948:10, Decode.scala:53:20, :54:23, :77:95, :108:38, :110:37, Mux.scala:81:{58,61}
  assign io_deio_reg_waddr = inst[11:7];	// <stdin>:948:10, Decode.scala:60:20, :63:15
  assign io_deio_branch_addr = {32'h0, io_fdio_pc} + {{52{inst[31]}}, inst[7], inst[30:25], inst[11:8], 1'h0};	// <stdin>:948:10, Cat.scala:33:92, Decode.scala:60:20, :75:17, :116:{39,58,79,88,101}, Mux.scala:81:58
  ...
  assign io_deio_reg2_rdata = _io_deio_reg2_rdata_T;	// <stdin>:948:10, Decode.scala:108:38
  assign io_deio_ld_type = _cu_io_ld_type;	// <stdin>:948:10, Decode.scala:53:20
  assign io_deio_csr_t = _io_deio_csr_t_T;	// <stdin>:948:10, Decode.scala:110:37
  assign io_deio_csr_waddr = (|_cu_io_csr_type) ? inst[31:20] : 12'h0;	// <stdin>:948:10, Decode.scala:53:20, :60:20, :124:{29,45}
  assign io_deio_csr_wen = |_cu_io_csr_type;	// <stdin>:948:10, Decode.scala:53:20, :124:45
  assign io_deio_has_inst = inst != 32'h13;	// <stdin>:948:10, Decode.scala:59:16, :60:20, :127:35
  assign io_jump_flag = _io_jump_pc_T | _io_jump_pc_T_3;	// <stdin>:948:10, Decode.scala:78:65, :130:{38,63}
  assign io_jump_pc = _io_jump_pc_T ? io_fdio_pc + _eximm_io_eximm[31:0] : _io_jump_pc_T_3 ? {_GEN[31:1], 1'h0} :
                32'h80000000;	// <stdin>:948:10, Decode.scala:54:23, :75:17, :78:65, :130:38, :134:71, :135:{121,139}, Mux.scala:101:16
  assign io_load_use = _load_use_T_16;	// <stdin>:948:10, Decode.scala:79:7
...
module FlowControl(	// <stdin>:1863:10
  ...
  wire Icache_stall;	// <stdin>:1868:5
  wire Dcache_stall;	// <stdin>:1870:5
...
module CSRs(	// <stdin>:2082:10
  ...
  `ifndef SYNTHESIS	// <stdin>:2082:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2082:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2082:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2082:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2082:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2082:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2082:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2082:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2082:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2082:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2082:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2082:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_CSRDe_csr_rdata = io_CSRDe_csr_raddr == 12'h340 ? MSCRATCH : io_CSRDe_csr_raddr == 12'h300 ? MSTATUS :
                ...
                MTVEC : 64'h0;	// <stdin>:2082:10, CSRs.scala:43:24, :44:25, :45:23, :46:22, :48:26, :49:27, :56:38, Mux.scala:81:{58,61}
  assign io_CSRTr_MTVEC = MTVEC;	// <stdin>:2082:10, CSRs.scala:43:24
  assign io_CSRTr_MCAUSE = MCAUSE;	// <stdin>:2082:10, CSRs.scala:44:25
  assign io_CSRTr_MEPC = MEPC;	// <stdin>:2082:10, CSRs.scala:45:23
  assign io_CSRTr_MIE = MIE;	// <stdin>:2082:10, CSRs.scala:46:22
  assign io_CSRTr_MIP = MIP;	// <stdin>:2082:10, CSRs.scala:47:22
  assign io_CSRTr_MSTATUS = MSTATUS;	// <stdin>:2082:10, CSRs.scala:48:26
endmodule

module Trap(	// <stdin>:2171:10
  input         clock,
                reset,
                io_ex_hasinst,
                io_mem_hasinst,
  ...
  `ifndef SYNTHESIS	// <stdin>:2171:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2171:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2171:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2171:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2171:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2171:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2171:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2171:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2171:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2171:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2171:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2171:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2171:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2171:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2171:10
        cause = {_RANDOM_0, _RANDOM_1};	// Trap.scala:45:24
        pc = _RANDOM_2;	// Trap.scala:46:21
        state = _RANDOM_3[2:0];	// Trap.scala:48:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2171:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2171:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_csrtr_rd = _GEN_0[state];	// <stdin>:2171:10, Trap.scala:48:24, :61:17, :64:18, :69:25, :106:25, :113:25, :121:25, :131:36, :145:25
  assign io_csrtr_csr_wen = ~_T & state != 3'h1 & (state == 3'h2 | state == 3'h3 | state == 3'h4 | state != 3'h5 &
                (state == 3'h6 ? _T_24 : (&state)));	// <stdin>:2171:10, Trap.scala:48:24, :59:22, :64:18, :68:30, :79:23, :83:23, :100:23, :105:30, :108:19, :115:19, :127:23, :131:36
  assign io_csrtr_csr_wdata = _GEN[state];	// <stdin>:2171:10, Trap.scala:48:24, :58:24, :64:18, :67:32, :104:32, :111:32, :119:32, :131:36, :143:32
  assign io_fctr_pop_NOP = _T & (_T_2 | _T_3 | _T_7);	// <stdin>:2171:10, Trap.scala:62:21, :64:18, :71:{57,74}, :78:33, :80:{32,62}, :85:57
  assign io_fctr_trap_state = state;	// <stdin>:2171:10, Trap.scala:48:24
  assign io_fctr_jump_flag = _T_26 | (&state);	// <stdin>:2171:10, Trap.scala:48:24, :154:18, :156:31
  assign io_fctr_jump_pc = _T_26 ? io_csrtr_MTVEC[31:0] : (&state) ? io_csrtr_MEPC[31:0] : 32'h0;	// <stdin>:2171:10, Trap.scala:46:21, :48:24, :153:21, :154:18, :157:29, :161:29
endmodule

module AXIArbitor(	// <stdin>:2305:10
  input         clock,
                reset,
  ...
  wire             _T = state == 2'h0;	// <stdin>:2311:22, AXIArbitor.scala:66:24, :99:18
  ...
  always @(posedge clock) begin
    if (reset) begin
      state <= 2'h0;	// <stdin>:2311:22, AXIArbitor.scala:66:24
      ...
      _GEN_6 = {{(&state) & r_comp ? 2'h0 : state}, {ar_comp ? 2'h3 : state}, {_T_4 ? 2'h0 : state},
                                                ...
                                                io_master1_req_bits_rw : io_master0_req_bits_rw) ? 2'h2 : 2'h1) : state}};	// <stdin>:2311:22, AXIArbitor.scala:43:25, :45:12, :53:{14,28}, :54:{8,22}, :66:24, :72:26, :73:25, :99:18, :102:35, :103:25, :104:27, :106:27, :127:{36,46}, :128:23, :147:26, :148:23, :155:25
  ...
  `ifndef SYNTHESIS	// <stdin>:2305:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2305:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2305:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2305:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2305:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2305:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2305:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2305:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2305:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2305:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2305:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_master0_resp_valid = ~_T & (_T_2 ? _T_4 & ~(_master_choose_T_1[0]) : ~_T_6 & (&state) & r_comp &
                ~(_master_choose_T_1[0]));	// <stdin>:2305:10, AXIArbitor.scala:43:25, :54:22, :66:24, :72:26, :73:25, :76:27, :81:23, :99:18, :127:{36,46}, :133:39, :136:43
  assign io_master0_resp_bits_data = _GEN_5[state];	// <stdin>:2305:10, AXIArbitor.scala:66:24, :77:31, :99:18
  assign io_master1_resp_valid = ~_T & (_T_2 ? _T_4 & _master_choose_T_1[0] : ~_T_6 & (&state) & r_comp &
                _master_choose_T_1[0]);	// <stdin>:2305:10, AXIArbitor.scala:43:25, :54:22, :66:24, :72:26, :73:25, :78:27, :81:23, :99:18, :127:{36,46}, :133:39
  assign io_master1_resp_bits_data = _GEN_4[state];	// <stdin>:2305:10, AXIArbitor.scala:66:24, :79:31, :99:18
  assign io_AXI_O_aw_valid = _GEN;	// <stdin>:2305:10, AXIArbitor.scala:81:23, :99:18
  assign io_AXI_O_aw_bits_addr = _GEN_0 ? 32'h0 : _addr_T_2;	// <stdin>:2305:10, AXIArbitor.scala:57:16, :58:8, :82:27, :99:18
  assign io_AXI_O_w_valid = _GEN_1;	// <stdin>:2305:10, AXIArbitor.scala:85:22, :99:18
  assign io_AXI_O_w_bits_data = _GEN_0 ? 64'h0 : _master_choose_T_1[0] ? io_master1_req_bits_data :
                io_master0_req_bits_data;	// <stdin>:2305:10, AXIArbitor.scala:43:25, :54:22, :61:16, :62:8, :82:27, :86:26, :99:18
  assign io_AXI_O_w_bits_strb = _T ? 8'h0 : {8{_T_2}};	// <stdin>:2305:10, AXIArbitor.scala:87:26, :99:18, :120:34
  assign io_AXI_O_ar_valid = _GEN_2;	// <stdin>:2305:10, AXIArbitor.scala:91:23, :99:18
  assign io_AXI_O_ar_bits_addr = _T | _T_2 | ~(_T_6 & _master_choose_T_1[1]) ? 32'h0 : _addr_T_2;	// <stdin>:2305:10, AXIArbitor.scala:43:25, :53:28, :57:16, :58:8, :92:27, :99:18, :143:35
  assign io_AXI_O_r_ready = _GEN_3;	// <stdin>:2305:10, AXIArbitor.scala:95:22, :99:18
endmodule

module Cache(	// <stdin>:2436:10, :3209:10
  input         clock,
                reset,
                io_cpu_req_valid,
  ...
  wire              _GEN;	// <stdin>:2509:18, :3282:18, Cache.scala:162:18
  ...
  wire              hit0;	// <stdin>:2457:5, :3230:5
  wire              hit1;	// <stdin>:2459:5, :3232:5
  wire [511:0]      _hit0_T_7 = valid >> {503'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:71:24, :91:{43,100}
  assign hit0 = _TagArray_ext_R4_data == io_cpu_req_bits_addr[31:11] & _hit0_T_7[0];	// Cache.scala:75:23, :91:{10,58,82,92,100}
  wire [8:0]        _GEN_0 = {io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:91:43, :92:57
  wire [9:0]        _GEN_1 = {1'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:91:43, :92:141
  ...
  wire [1023:0]     _GEN_2 = {1015'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:91:43, :235:55
  ...
  wire              _GEN_3 = ~io_cpu_req_valid | (|io_cpu_req_bits_mask) | ~_T_3;	// <stdin>:2505:14, :3278:14, Cache.scala:129:28, :139:37, :171:35, :173:{43,47}, :210:38, :215:35
  ...
  wire [511:0]      _GEN_4 = {503'h0, index, 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :91:100, :275:40
  wire [511:0]      _replace_wire_T_1 = replace >> _GEN_4;	// Cache.scala:73:26, :275:40
  wire [9:0]        _GEN_5 = {1'h0, index, 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :278:34
  wire [9:0]        _GEN_6 = {9'h0, _GEN};	// <stdin>:2509:18, :3282:18, Cache.scala:162:18, :278:34, :379:70
  wire [511:0]      _T_9 = dirty >> _GEN_5 + _GEN_6;	// Cache.scala:72:24, :278:{23,34}
  wire [8:0]        _GEN_7 = {index, 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :278:34
  wire [8:0]        _GEN_8 = {8'h0, _GEN};	// <stdin>:2509:18, :3282:18, Cache.scala:120:23, :162:18, :278:34
  ...
  wire [1023:0]     _GEN_12 = {1015'h0, index, 1'h0};	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :235:55, :321:47
  ...
  assign _GEN = ~_T & (_T_5 ? _replace_wire_T_1[0] : ~_T_11 & ~(&state) & ~_T_26 & _T_67 &
                _replace_wire_T_5[0]);	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :77:32, :162:18, :275:{26,40}, :395:40
  wire [511:0]      _T_71 = dirty >> _GEN_5 + _GEN_6;	// Cache.scala:72:24, :278:34, :398:{23,34}
  wire              _GEN_17 = ~_T & ~_T_5 & ~_T_11 & ~(&state) & ~_T_26 & _T_67 & _T_71[0];	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :77:32, :162:18, :398:23
  wire              _T_73 = state == 3'h3;	// Cache.scala:64:24, :162:18, :399:23
  wire              _GEN_18 = ~_T & ~_T_5 & ~_T_11 & ~(&state) & ~_T_26 & ~_T_67 & _T_73;	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :77:32, :115:21, :162:18
  ...
  wire              _GEN_20 = ~_T & ~_T_5 & ~_T_11 & ~(&state) & ~_T_26 & ~_T_67 & ~_T_73 & _T_74 & _GEN_13;	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :77:32, :115:21, :162:18, :313:36, :318:29
  ...
  wire [7:0][511:0] _GEN_22 = {{io_axi_resp_valid ? (victim ? replace | _replace0_T_17[511:0] : ~(~replace |
                ...
                ? 512'h0 : hit0 ? ~(~replace | _replace0_T_2[511:0]) : replace | _replace0_T_10[511:0]}};	// <stdin>:2505:14, :3278:14, Cache.scala:71:24, :72:24, :73:26, :115:21, :125:26, :129:28, :162:18, :171:35, :173:47, :215:35, :235:{38,55}, :250:{38,55}, :313:36, :318:29, :321:{30,47}, :330:{30,47}, :357:26, :369:{26,43}, :385:{26,43}, :439:29, :442:{30,47}, :459:{30,47}
  wire [511:0]      _GEN_23 = _GEN_22[state];	// <stdin>:2505:14, :3278:14, Cache.scala:64:24, :162:18, :171:35, :313:36, :357:26
  ...
  wire [7:0][511:0] _GEN_24 = {{io_axi_resp_valid ? (victim ? ~(~replace | _replace1_T_23[511:0]) : replace |
                ...
                ? 512'h0 : hit0 ? replace | _replace1_T_4[511:0] : ~(~replace | _replace1_T_14[511:0])}};	// <stdin>:2505:14, :2507:14, :3278:14, :3280:14, Cache.scala:71:24, :72:24, :73:26, :115:21, :125:26, :129:28, :162:18, :171:35, :173:47, :215:35, :236:{38,55}, :250:55, :251:{38,55}, :313:36, :318:29, :321:47, :322:{30,47}, :331:{30,47}, :357:26, :369:43, :370:{26,43}, :386:{26,43}, :439:29, :442:47, :443:{30,47}, :460:{30,47}
  wire [511:0]      _GEN_25 = _GEN_24[state];	// <stdin>:2507:14, :3280:14, Cache.scala:64:24, :162:18, :171:35, :313:36, :357:26
  wire              _GEN_26 = ~_T & ~_T_5 & ~_T_11 & ~(&state) & ~_T_26 & ~_T_67 & ~_T_73 & _T_74 & _GEN_15;	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :77:32, :115:21, :162:18, :313:36, :318:29
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      inDataOneArray <= 1'h0;	// <stdin>:2436:10, :3209:10, Cache.scala:103:33
      addr <= 32'h0;	// Cache.scala:118:23, :379:70
      data <= 64'h0;	// Cache.scala:119:23
      mask <= 8'h0;	// Cache.scala:120:23
      inst_type <= 1'h0;	// <stdin>:2436:10, :3209:10, Cache.scala:122:28
      whitNum <= 1'h0;	// <stdin>:2436:10, :3209:10, Cache.scala:125:26
      cpu_resp_valid <= 1'h0;	// <stdin>:2436:10, :3209:10, Cache.scala:138:33
      cpu_resp_bits_data <= 64'h0;	// Cache.scala:119:23, :139:37
      axi_req_valid <= 1'h0;	// <stdin>:2436:10, :3209:10, Cache.scala:140:32
      axi_req_bits_rw <= 1'h0;	// <stdin>:2436:10, :3209:10, Cache.scala:141:34
      ...
      _GEN_31 = {{io_axi_resp_valid ? (victim ? _GEN_23 | _GEN_25 : _GEN_23 | _GEN_25) : replace},
                                                ...
                                                : hit0 ? _GEN_23 | _GEN_25 : _GEN_23 | _GEN_25}};	// <stdin>:2505:14, :3278:14, Cache.scala:72:24, :73:26, :115:21, :125:26, :129:28, :162:18, :171:35, :173:47, :215:35, :237:{37,49}, :252:{37,49}, :313:36, :318:29, :323:{29,41}, :332:{29,41}, :357:26, :371:{25,37}, :387:{25,37}, :439:29, :444:{29,41}, :461:{29,41}
      ...
      axi_req_valid <= ~_T & (_T_5 | _T_11 | ((&state) ? ~io_axi_resp_valid : ~_T_26 & (_T_67 | _T_73 | _T_74 &
                                                ~io_axi_resp_valid)));	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :140:32, :159:19, :162:18, :278:50, :309:27, :313:36, :316:31, :398:50, :433:36
    ...
    victim <= ~_T & (_T_5 | ~(_T_11 | (&state) | _T_26 | ~_T_67) ? _GEN : victim);	// <stdin>:2509:18, :3282:18, Cache.scala:64:24, :75:23, :115:21, :162:18, :165:20, :276:20
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:2436:10, :3209:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2436:10, :3209:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2436:10, :3209:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_53;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_54;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_55;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_56;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_57;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_58;	// <stdin>:2436:10, :3209:10
      automatic logic [31:0] _RANDOM_59;	// <stdin>:2436:10, :3209:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2436:10, :3209:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2436:10, :3209:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2436:10, :3209:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_15 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_16 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_17 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_18 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_19 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_20 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_21 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_22 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_23 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_24 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_25 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_26 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_27 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_28 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_29 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_30 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_31 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_32 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_33 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_34 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_35 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_36 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_37 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_38 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_39 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_40 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_41 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_42 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_43 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_44 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_45 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_46 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_47 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_48 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_49 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_50 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_51 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_52 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_53 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_54 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_55 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_56 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_57 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_58 = `RANDOM;	// <stdin>:2436:10, :3209:10
        _RANDOM_59 = `RANDOM;	// <stdin>:2436:10, :3209:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2436:10, :3209:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2436:10, :3209:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  TagArray_combMem TagArray_ext (	// Cache.scala:75:23
    ...
    .R3_clk  (clock),
    .R4_addr ({io_cpu_req_bits_addr[10:3], 1'h0}),	// <stdin>:2436:10, :3209:10, Cache.scala:91:{22,43}
    .R4_en   (1'h1),	// <stdin>:2436:10, :3209:10
    .R4_clk  (clock),
    .R5_addr (_GEN_0 + 9'h1),	// Cache.scala:92:57
    .R5_en   (1'h1),	// <stdin>:2436:10, :3209:10
    .R5_clk  (clock),
    .W0_addr (_GEN_7 + 9'h1),	// Cache.scala:92:57, :278:34, :325:42
    .W0_en   (_GEN_14),	// Cache.scala:75:23, :162:18
    .W0_clk  (clock),
    .W0_data (tag),	// Cache.scala:67:18
    .W1_addr ({index, 1'h0}),	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :334:29
    ...
    .W3_addr ({index, 1'h0}),	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :463:29
  ...
  DataArray_combMem DataArray_ext (	// Cache.scala:77:32
    ...
    .W1_addr ({index, 1'h0}),	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :335:30
    .W1_en   (_GEN_16),	// Cache.scala:75:23, :162:18
    .W1_clk  (clock),
    ...
    .W3_addr ({index, 1'h0}),	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :374:26
    ...
    .W5_addr ({index, 1'h0}),	// <stdin>:2436:10, :3209:10, Cache.scala:68:20, :464:30
  ...
  assign io_cpu_resp_valid = cpu_resp_valid;	// <stdin>:2436:10, :3209:10, Cache.scala:138:33
  assign io_cpu_resp_bits_data = inDataOneArray ? (inst_type ? {32'h0, _T_25 ? _DataArray_ext_R0_data[31:0] :
                _DataArray_ext_R0_data[63:32]} : _DataArray_ext_R0_data) : cpu_resp_bits_data;	// <stdin>:2436:10, :3209:10, Cache.scala:77:32, :103:33, :122:28, :139:37, :148:33, :149:{12,27,35,56,76}, :379:70
  assign io_axi_req_valid = axi_req_valid;	// <stdin>:2436:10, :3209:10, Cache.scala:140:32
  assign io_axi_req_bits_rw = axi_req_bits_rw;	// <stdin>:2436:10, :3209:10, Cache.scala:141:34
  assign io_axi_req_bits_addr = axi_req_bits_addr;	// <stdin>:2436:10, :3209:10, Cache.scala:142:36
  assign io_axi_req_bits_data = axi_req_bits_data;	// <stdin>:2436:10, :3209:10, Cache.scala:143:36
  assign io_fccache_req = io_cpu_req_valid;	// <stdin>:2436:10, :3209:10
  assign io_fccache_state = state;	// <stdin>:2436:10, :3209:10, Cache.scala:64:24
  assign io_fccache_mask = io_cpu_req_bits_mask;	// <stdin>:2436:10, :3209:10
  assign io_fccache_hit = _T_3;	// <stdin>:2436:10, :3209:10, Cache.scala:129:28
  assign io_fccache_cpu_valid = cpu_resp_valid;	// <stdin>:2436:10, :3209:10, Cache.scala:138:33
  assign io_fccache_axi_valid = io_axi_resp_valid;	// <stdin>:2436:10, :3209:10
endmodule
...
module Core(	// <stdin>:4010:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      fdreg_pc <= 32'h80000000;	// <stdin>:4031:23, Core.scala:33:24
      dereg_op_a <= 64'h0;	// Core.scala:39:24, :433:33
      dereg_op_b <= 64'h0;	// Core.scala:39:24, :433:33
      dereg_reg_waddr <= 5'h0;	// <stdin>:4047:27, Core.scala:39:24
      dereg_branch_type <= 1'h0;	// Core.scala:39:24, :105:24
      dereg_branch_addr <= 64'h0;	// Core.scala:39:24, :433:33
      dereg_alu_op <= 6'h3F;	// <stdin>:4044:27, Core.scala:39:24
      dereg_shamt <= 6'h0;	// <stdin>:4043:23, Core.scala:39:24
      dereg_wb_type <= 2'h0;	// <stdin>:4042:25, Core.scala:39:24
      dereg_sd_type <= 3'h0;	// <stdin>:4010:10, Core.scala:39:24
      dereg_reg2_rdata <= 64'h0;	// Core.scala:39:24, :433:33
      dereg_ld_type <= 3'h0;	// <stdin>:4010:10, Core.scala:39:24
      dereg_csr_t <= 64'h0;	// Core.scala:39:24, :433:33
      dereg_csr_waddr <= 12'h0;	// <stdin>:4037:27, Core.scala:39:24
      dereg_csr_wen <= 1'h0;	// Core.scala:39:24, :105:24
      emreg_reg_wdata <= 64'h0;	// Core.scala:57:24, :433:33
      emreg_reg_waddr <= 5'h0;	// <stdin>:4047:27, Core.scala:57:24
      emreg_wb_type <= 2'h0;	// <stdin>:4042:25, Core.scala:57:24
      emreg_ld_type <= 3'h0;	// <stdin>:4010:10, Core.scala:57:24
      emreg_ld_addr_lowbit <= 3'h0;	// <stdin>:4010:10, Core.scala:57:24
      emreg_csr_wdata <= 64'h0;	// Core.scala:57:24, :433:33
      emreg_csr_wen <= 1'h0;	// Core.scala:57:24, :105:24
      emreg_csr_waddr <= 12'h0;	// <stdin>:4037:27, Core.scala:57:24
      mwreg_reg_wdata <= 64'h0;	// Core.scala:71:24, :433:33
      mwreg_reg_waddr <= 5'h0;	// <stdin>:4047:27, Core.scala:71:24
      mwreg_wb_type <= 2'h0;	// <stdin>:4042:25, Core.scala:71:24
      mwreg_csr_wdata <= 64'h0;	// Core.scala:71:24, :433:33
      mwreg_csr_wen <= 1'h0;	// Core.scala:71:24, :105:24
      mwreg_csr_waddr <= 12'h0;	// <stdin>:4037:27, Core.scala:71:24
    end
    else begin
      ...
      if (_fc_io_fcde_stall) begin	// Core.scala:92:20
        ...
        if (_fc_io_fcde_flush) begin	// Core.scala:92:20
          ...
          dereg_reg_waddr <= 5'h0;	// <stdin>:4047:27, Core.scala:39:24
          dereg_branch_addr <= 64'h0;	// Core.scala:39:24, :433:33
          dereg_alu_op <= 6'h0;	// <stdin>:4043:23, Core.scala:39:24
          dereg_shamt <= 6'h0;	// <stdin>:4043:23, Core.scala:39:24
          dereg_wb_type <= 2'h0;	// <stdin>:4042:25, Core.scala:39:24
          dereg_sd_type <= 3'h0;	// <stdin>:4010:10, Core.scala:39:24
          dereg_reg2_rdata <= 64'h0;	// Core.scala:39:24, :433:33
  ...
  Cache Icache (	// Core.scala:104:24
    ...
    .io_cpu_req_bits_inst_type (1'h1),	// <stdin>:4010:10
