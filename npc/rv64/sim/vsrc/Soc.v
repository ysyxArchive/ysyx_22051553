...
module Fetch(	// <stdin>:8:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      else if (_next_pc_T_2)	// Fetch.scala:34:36
  ...
  assign io_pc_valid = ~io_fcfe_stall & started;	// <stdin>:8:10, Fetch.scala:25:26, :56:23
...
module ControlUnit(	// <stdin>:44:10
  ...
  assign io_imm_type = {1'h0, _controlsig_T_1 ? 2'h0 : _GEN_5 ? 2'h1 : _controlsig_T_7 ? 2'h2 : _controlsig_T_9 |
                ...
                {2{_controlsig_T_43}}};	// <stdin>:44:10, ControlUnit.scala:168:21, Lookup.scala:31:38, :34:39
...
module Decode(	// <stdin>:810:10
  ...
  wire [63:0]      _eximm_io_eximm;	// Decode.scala:47:23
  wire [1:0]       _cu_io_jump_type;	// Decode.scala:46:20
  wire [1:0]       _cu_io_opa_type;	// Decode.scala:46:20
  wire [1:0]       _cu_io_opb_type;	// Decode.scala:46:20
  wire [2:0]       _cu_io_imm_type;	// Decode.scala:46:20
  wire [2:0]       _cu_io_ld_type;	// Decode.scala:46:20
  reg  [4:0]       lu_rd;	// Decode.scala:63:24
  wire             _io_deio_op_a_T_5 = _cu_io_opa_type == 2'h2;	// Decode.scala:46:20, :68:34
  wire [63:0]      _io_jump_pc_T_4 = io_fwde_fw_sel1 ? io_fwde_fw_data1 : io_rfio_reg1_rdata;	// Decode.scala:83:38
  wire [63:0]      _io_deio_reg2_rdata_T = io_fwde_fw_sel2 ? io_fwde_fw_data2 : io_rfio_reg2_rdata;	// Decode.scala:92:38
  wire [3:0][63:0] _GEN = {{64'h4}, {_io_deio_reg2_rdata_T}, {_eximm_io_eximm}, {64'h0}};	// Decode.scala:47:23, :68:95, :92:38, Mux.scala:81:{58,61}
  wire             _io_jump_pc_T = _cu_io_jump_type == 2'h1;	// Decode.scala:46:20, :108:38, Mux.scala:81:61
  wire             _io_jump_pc_T_3 = _cu_io_jump_type == 2'h2;	// Decode.scala:46:20, :68:34, :108:82
  always @(posedge clock) begin
    if (reset)
      lu_rd <= 5'h0;	// Decode.scala:63:24
    else if (io_branch | _cu_io_ld_type == 3'h0)	// Decode.scala:46:20, :65:17, :66:32
      lu_rd <= 5'h0;	// Decode.scala:63:24
    else	// Decode.scala:46:20, :65:17, :66:32
      lu_rd <= io_inst_bits[11:7];	// Decode.scala:58:15, :63:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:810:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:810:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:810:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:810:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:810:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:810:10
        `INIT_RANDOM_PROLOG_	// <stdin>:810:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:810:10
        _RANDOM_0 = `RANDOM;	// <stdin>:810:10
        lu_rd = _RANDOM_0[4:0];	// Decode.scala:63:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:810:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:810:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ControlUnit cu (	// Decode.scala:46:20
  ...
  Eximm eximm (	// Decode.scala:47:23
    .io_inst     (io_inst_bits),
    .io_imm_type (_cu_io_imm_type),	// Decode.scala:46:20
    .io_eximm    (_eximm_io_eximm)
  );
  assign io_rfio_reg1_raddr = io_inst_bits[19:15];	// <stdin>:810:10, Decode.scala:56:16
  assign io_rfio_reg2_raddr = io_inst_bits[24:20];	// <stdin>:810:10, Decode.scala:57:16
  assign io_deio_op_a = _io_deio_op_a_T_5 ? _io_jump_pc_T_4 : _cu_io_opa_type == 2'h1 ? io_fdio_pc : 64'h0;	// <stdin>:810:10, Decode.scala:46:20, :68:34, :83:38, Mux.scala:81:{58,61}
  assign io_deio_op_b = _GEN[_cu_io_opb_type];	// <stdin>:810:10, Decode.scala:46:20, :68:95, Mux.scala:81:{58,61}
  assign io_deio_rd = io_inst_bits[11:7];	// <stdin>:810:10, Decode.scala:58:15
  assign io_deio_branch_addr = io_fdio_pc + {{52{io_inst_bits[31]}}, io_inst_bits[7], io_inst_bits[30:25],
                io_inst_bits[11:8], 1'h0};	// <stdin>:810:10, Cat.scala:33:92, Decode.scala:66:17, :99:{39,58,79,88,101}
  assign io_deio_shamt = io_inst_bits[24:20];	// <stdin>:810:10, Decode.scala:59:11
  assign io_deio_reg2_rdata = _io_deio_reg2_rdata_T;	// <stdin>:810:10, Decode.scala:92:38
  assign io_deio_ld_type = _cu_io_ld_type;	// <stdin>:810:10, Decode.scala:46:20
  assign io_jump_flag = _io_jump_pc_T | _io_jump_pc_T_3;	// <stdin>:810:10, Decode.scala:108:{38,63,82}
  assign io_jump_pc = _io_jump_pc_T ? io_fdio_pc + _eximm_io_eximm : _io_jump_pc_T_3 ? _io_jump_pc_T_4 +
                _eximm_io_eximm & 64'hFFFFFFFFFFFFFFFE : 64'h80000000;	// <stdin>:810:10, Decode.scala:47:23, :83:38, :108:{38,82}, :112:71, :113:{121,139,142}, Mux.scala:101:16
  assign io_load_use = (_io_deio_op_a_T_5 & io_inst_bits[19:15] == lu_rd | _cu_io_opb_type == 2'h2 &
                io_inst_bits[24:20] == lu_rd) & (|lu_rd);	// <stdin>:810:10, Decode.scala:46:20, :56:16, :57:16, :63:24, :68:{34,57,64,75,95,118,125,138,148}
  assign io_fwde_reg1_raddr = io_inst_bits[19:15];	// <stdin>:810:10, Decode.scala:56:16
  assign io_fwde_reg2_raddr = io_inst_bits[24:20];	// <stdin>:810:10, Decode.scala:57:16
endmodule

module Alu(	// <stdin>:918:10
  input  [63:0] io_op_a,
                io_op_b,
  input  [5:0]  io_alu_op,
  input  [4:0]  io_shamt,
  ...
  assign io_result = (&io_alu_op) ? 64'h0 : io_alu_op == 6'h27 ? {{32{_res_T_127[31]}}, _res_T_127[31:0]} :
                ...
                : _res_T_168[63:0];	// <stdin>:918:10, Alu.scala:99:34, :100:34, :104:34, :105:45, :106:{37,47}, :107:{36,46}, :108:40, :109:34, :110:40, :111:34, :113:48, :114:48, :115:{43,55}, :117:35, :118:{35,51}, :119:{35,51}, :120:{42,58}, :121:45, :122:{42,59}, :123:46, :124:{42,59}, :125:46, Mux.scala:81:{58,61}
endmodule

module Excute(	// <stdin>:1151:10
  ...
  assign io_emio_alu_res = _alu_io_result;	// <stdin>:1151:10, Excute.scala:32:21
  assign io_emio_wb_type = io_deio_wb_type;	// <stdin>:1151:10
  assign io_emio_rd = io_deio_rd;	// <stdin>:1151:10
  assign io_emio_ld_type = io_deio_ld_type;	// <stdin>:1151:10
  assign io_emio_ld_addr_lowbit = _io_raddr_T_1[2:0];	// <stdin>:1151:10, Excute.scala:44:39, :51:20
  assign io_jump_flag = io_deio_branch_type & (|_alu_io_result);	// <stdin>:1151:10, Excute.scala:32:21, :47:{50,69}
  assign io_jump_pc = io_deio_branch_addr;	// <stdin>:1151:10
  assign io_raddr = _io_raddr_T_1;	// <stdin>:1151:10, Excute.scala:51:20
  assign io_waddr = (|io_deio_sd_type) ? _alu_io_result : 64'h0;	// <stdin>:1151:10, Excute.scala:32:21, :51:20, :53:{20,37}
  assign io_wdata = io_deio_reg2_rdata;	// <stdin>:1151:10
  assign io_wmask = io_deio_sd_type == 3'h4 ? 8'hFF : {4'h0, io_deio_sd_type == 3'h3 ? 4'hF : {2'h0,
                io_deio_sd_type == 3'h2 ? 2'h3 : {1'h0, io_deio_sd_type == 3'h1}}};	// <stdin>:1151:10, Mux.scala:81:{58,61}
  assign io_fwex_reg_waddr = io_deio_rd;	// <stdin>:1151:10
  assign io_fwex_reg_wdata = _alu_io_result;	// <stdin>:1151:10, Excute.scala:32:21
  assign io_fwex_reg_we = io_deio_wb_type == 2'h1;	// <stdin>:1151:10, Excute.scala:65:40
endmodule

module Mem(	// <stdin>:1195:10
  ...
  assign io_mwio_wb_type = io_emio_wb_type;	// <stdin>:1195:10
  assign io_mwio_wb_data = _io_fwmem_reg_wdata_T ? io_emio_alu_res : _io_fwmem_reg_wdata_T_1 ? rvalue : 64'h0;	// <stdin>:1195:10, Mem.scala:89:30, :90:30, Mux.scala:81:58, :101:16
  assign io_mwio_rd = io_emio_rd;	// <stdin>:1195:10
  assign io_fwmem_reg_waddr = io_emio_rd;	// <stdin>:1195:10
  assign io_fwmem_reg_wdata = _io_fwmem_reg_wdata_T ? io_emio_alu_res : _io_fwmem_reg_wdata_T_1 ? rvalue : 64'h0;	// <stdin>:1195:10, Mem.scala:89:30, :90:30, Mux.scala:81:58, :101:16
  assign io_fwmem_reg_we = _io_fwmem_reg_wdata_T | _io_fwmem_reg_wdata_T_1;	// <stdin>:1195:10, Mem.scala:89:30, :90:30, :96:52
endmodule

module Wb(	// <stdin>:1398:10
  ...
  assign io_rfio_rd = io_mwio_rd;	// <stdin>:1398:10
  assign io_rfio_reg_wen = |io_mwio_wb_type;	// <stdin>:1398:10, Wb.scala:24:40
  assign io_rfio_reg_wdata = io_mwio_wb_data;	// <stdin>:1398:10
  assign io_fwwb_reg_waddr = io_mwio_rd;	// <stdin>:1398:10
  assign io_fwwb_reg_wdata = io_mwio_wb_data;	// <stdin>:1398:10
  assign io_fwwb_reg_we = |io_mwio_wb_type;	// <stdin>:1398:10, Wb.scala:24:40
endmodule

module Regfile(	// <stdin>:1412:10
  input         clock,
  ...
  regs_combMem regs_ext (	// Regfile.scala:32:19
    .R0_addr (io_RfWb_rd),
    .R0_en   (1'h1),	// <stdin>:1412:10
    .R0_clk  (clock),
    .R1_addr (io_RfDe_reg1_raddr),
    .R1_en   (1'h1),	// <stdin>:1412:10
    .R1_clk  (clock),
    .R2_addr (io_RfDe_reg2_raddr),
    .R2_en   (1'h1),	// <stdin>:1412:10
    .R2_clk  (clock),
    .W0_addr (5'h0),	// Regfile.scala:37:9
    .W0_en   (1'h1),	// <stdin>:1412:10
    .W0_clk  (clock),
    .W0_data (64'h0),	// Regfile.scala:37:13
    .W1_addr (io_RfWb_rd),
    .W1_en   (1'h1),	// <stdin>:1412:10
    .W1_clk  (clock),
  ...
  assign io_RfDe_reg1_rdata = (|io_RfDe_reg1_raddr) ? _regs_ext_R1_data : 64'h0;	// <stdin>:1412:10, Regfile.scala:32:19, :37:13, :48:{30,50}
  assign io_RfDe_reg2_rdata = (|io_RfDe_reg2_raddr) ? _regs_ext_R2_data : 64'h0;	// <stdin>:1412:10, Regfile.scala:32:19, :37:13, :49:{30,50}
endmodule

module FlowControl(	// <stdin>:1435:10
  ...
  assign io_fcfe_jump_flag = io_fcde_jump_flag | io_fcex_jump_flag;	// <stdin>:1435:10, FlowControl.scala:101:44
  assign io_fcfe_jump_pc = io_fcex_jump_flag ? io_fcex_jump_pc : io_fcde_jump_flag ? io_fcde_jump_pc : 64'h80000000;	// <stdin>:1435:10, Mux.scala:101:16
  assign io_fcfe_flush = io_fcex_jump_flag | io_fcde_jump_flag;	// <stdin>:1435:10, Mux.scala:101:16
  assign io_fcfe_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1435:10, Mux.scala:101:16
  assign io_fcde_flush = io_fcex_jump_flag;	// <stdin>:1435:10
  assign io_fcde_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1435:10, Mux.scala:101:16
  assign io_fcex_flush = io_fcex_jump_flag;	// <stdin>:1435:10
  assign io_fcex_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1435:10, Mux.scala:101:16
  assign io_fcmem_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1435:10, Mux.scala:101:16
endmodule

module Forward(	// <stdin>:1506:10
  ...
  assign io_fwde_fw_sel1 = reg1_ex_hazard | reg1_mem_hazard | reg1_wb_hazard;	// <stdin>:1506:10, Forward.scala:38:73, :41:75, :44:73, :47:57
  assign io_fwde_fw_sel2 = reg2_ex_hazard | reg2_mem_hazard | reg2_wb_hazard;	// <stdin>:1506:10, Forward.scala:39:73, :42:75, :45:73, :48:57
  assign io_fwde_fw_data1 = reg1_ex_hazard ? io_fwex_reg_wdata : reg1_mem_hazard ? io_fwmem_reg_wdata : reg1_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:1506:10, Forward.scala:38:73, :41:75, :44:73, Mux.scala:101:16
  assign io_fwde_fw_data2 = reg2_ex_hazard ? io_fwex_reg_wdata : reg2_mem_hazard ? io_fwmem_reg_wdata : reg2_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:1506:10, Forward.scala:39:73, :42:75, :45:73, Mux.scala:101:16
endmodule

// external module DebugInterface

module Core(	// <stdin>:1567:10
  input         clock,
                reset,
  input  [63:0] io_inst,
                io_rdata,
  ...
  wire        _fw_io_fwde_fw_sel1;	// Core.scala:291:20
  wire        _fw_io_fwde_fw_sel2;	// Core.scala:291:20
  wire [63:0] _fw_io_fwde_fw_data1;	// Core.scala:291:20
  wire [63:0] _fw_io_fwde_fw_data2;	// Core.scala:291:20
  ...
  wire        _decode_io_load_use;	// Core.scala:40:24
  ...
  always @(posedge clock) begin
    if (reset) begin
      fdreg_pc <= 64'h80000000;	// <stdin>:1596:20, Core.scala:48:24
      dereg_op_a <= 64'h0;	// <stdin>:1601:28, Core.scala:53:24
      dereg_op_b <= 64'h0;	// <stdin>:1601:28, Core.scala:53:24
      dereg_rd <= 5'h0;	// <stdin>:1604:23, Core.scala:53:24
      dereg_branch_type <= 1'h0;	// Core.scala:53:24, :298:19
      dereg_branch_addr <= 64'h0;	// <stdin>:1601:28, Core.scala:53:24
      dereg_alu_op <= 6'h3F;	// <stdin>:1605:27, Core.scala:53:24
      dereg_shamt <= 5'h0;	// <stdin>:1604:23, Core.scala:53:24
      dereg_wb_type <= 2'h0;	// <stdin>:1603:25, Core.scala:53:24
      dereg_sd_type <= 3'h0;	// <stdin>:1600:25, Core.scala:53:24
      dereg_reg2_rdata <= 64'h0;	// <stdin>:1601:28, Core.scala:53:24
      dereg_ld_type <= 3'h0;	// <stdin>:1600:25, Core.scala:53:24
      emreg_alu_res <= 64'h0;	// <stdin>:1601:28, Core.scala:69:24
      emreg_wb_type <= 2'h0;	// <stdin>:1603:25, Core.scala:69:24
      emreg_rd <= 5'h0;	// <stdin>:1604:23, Core.scala:69:24
      emreg_ld_type <= 3'h0;	// <stdin>:1600:25, Core.scala:69:24
      emreg_ld_addr_lowbit <= 3'h0;	// <stdin>:1600:25, Core.scala:69:24
      mwreg_wb_type <= 2'h0;	// <stdin>:1603:25, Core.scala:79:24
      mwreg_wb_data <= 64'h0;	// <stdin>:1601:28, Core.scala:79:24
      mwreg_rd <= 5'h0;	// <stdin>:1604:23, Core.scala:79:24
    end
    else begin
      ...
      else if (_fc_io_fcex_flush) begin	// Core.scala:91:20
        emreg_alu_res <= 64'h0;	// <stdin>:1601:28, Core.scala:69:24
        emreg_wb_type <= 2'h0;	// <stdin>:1603:25, Core.scala:69:24
        emreg_rd <= 5'h0;	// <stdin>:1604:23, Core.scala:69:24
        emreg_ld_type <= 3'h0;	// <stdin>:1600:25, Core.scala:69:24
  ...
  `ifndef SYNTHESIS	// <stdin>:1567:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1567:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1567:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:1567:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:1567:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1567:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1567:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1567:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_3 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_7 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_8 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_9 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_10 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_11 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_12 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_13 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_14 = `RANDOM;	// <stdin>:1567:10
        _RANDOM_15 = `RANDOM;	// <stdin>:1567:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1567:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1567:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  Decode decode (	// Core.scala:40:24
    ...
    .io_branch           (_excute_io_jump_flag),	// Core.scala:41:24
    .io_fwde_fw_sel1     (_fw_io_fwde_fw_sel1),	// Core.scala:291:20
    .io_fwde_fw_sel2     (_fw_io_fwde_fw_sel2),	// Core.scala:291:20
    .io_fwde_fw_data1    (_fw_io_fwde_fw_data1),	// Core.scala:291:20
    .io_fwde_fw_data2    (_fw_io_fwde_fw_data2),	// Core.scala:291:20
  ...
  FlowControl fc (	// Core.scala:91:20
    ...
    .io_fcde_load_use  (_decode_io_load_use),	// Core.scala:40:24
  ...
  DebugInterface DI (	// Core.scala:298:19
    .clk        (clock),
    .rst        (reset),
    .pc         (_fetch_io_pc_bits),	// Core.scala:39:23
    .pc_req     (_fetch_io_pc_valid),	// Core.scala:39:23
    .inst       (fdreg_pc[2] ? io_inst[63:32] : io_inst[31:0]),	// Core.scala:48:24, :110:{40,60,76}, :303:22
    .inst_valid (1'h0),	// Core.scala:298:19
    .load_use   (_decode_io_load_use),	// Core.scala:40:24
    .op_a       (dereg_op_a),	// Core.scala:53:24
    .op_b       (dereg_op_b),	// Core.scala:53:24
    .result     (_excute_io_emio_alu_res),	// Core.scala:41:24
    .br_yes     (_excute_io_jump_flag),	// Core.scala:41:24
  ...
  assign io_pc = _fetch_io_pc_bits;	// <stdin>:1567:10, Core.scala:39:23
  assign io_valid = _fetch_io_pc_valid;	// <stdin>:1567:10, Core.scala:39:23
endmodule

// external module TempMem

module Soc(	// <stdin>:1796:10
  input         clock,
                reset,
  output [63:0] io_next_pc);
