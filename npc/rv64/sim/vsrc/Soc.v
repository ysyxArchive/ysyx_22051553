...
module Decode(	// <stdin>:810:10
  ...
  wire             _io_deio_op_a_T_5 = _cu_io_opa_type == 2'h2;	// Decode.scala:43:20, :63:34
  ...
  wire [3:0][63:0] _GEN = {{64'h4}, {_io_deio_reg2_rdata_T}, {_eximm_io_eximm}, {64'h0}};	// Decode.scala:44:23, :63:95, :87:38, Mux.scala:81:{58,61}
  wire             _io_jump_pc_T = _cu_io_jump_type == 2'h1;	// Decode.scala:43:20, :103:38, Mux.scala:81:61
  wire             _io_jump_pc_T_3 = _cu_io_jump_type == 2'h2;	// Decode.scala:43:20, :63:34, :103:82
  always @(posedge clock) begin
    if (reset)
  ...
  assign io_deio_op_a = _io_deio_op_a_T_5 ? _io_jump_pc_T_4 : _cu_io_opa_type == 2'h1 ? io_fdio_pc : 64'h0;	// <stdin>:810:10, Decode.scala:43:20, :63:34, :78:38, Mux.scala:81:{58,61}
  assign io_deio_op_b = _GEN[_cu_io_opb_type];	// <stdin>:810:10, Decode.scala:43:20, :63:95, Mux.scala:81:{58,61}
  ...
  assign io_load_use = (_io_deio_op_a_T_5 & io_inst_bits[19:15] == lu_rd | _cu_io_opb_type == 2'h2 &
                io_inst_bits[24:20] == lu_rd) & (|lu_rd);	// <stdin>:810:10, Decode.scala:43:20, :53:16, :54:16, :60:24, :63:{34,57,64,75,95,118,125,138,148}
...
module Alu(	// <stdin>:917:10
  ...
  assign io_result = (&io_alu_op) ? 64'h0 : io_alu_op == 6'h27 ? {{32{_res_T_127[31]}}, _res_T_127[31:0]} :
                ...
                : _res_T_168[63:0];	// <stdin>:917:10, Alu.scala:99:34, :100:34, :104:34, :105:45, :106:{37,47}, :107:{36,46}, :108:40, :109:34, :110:40, :111:34, :113:48, :114:48, :115:{43,55}, :117:35, :118:{35,51}, :119:{35,51}, :120:{42,58}, :121:45, :122:{42,59}, :123:46, :124:{42,59}, :125:46, Mux.scala:81:{58,61}
endmodule
...
module FlowControl(	// <stdin>:1434:10
  ...
  assign io_fcde_flush = io_fcex_jump_flag;	// <stdin>:1434:10
  assign io_fcde_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1434:10, Mux.scala:101:16
  assign io_fcex_flush = io_fcex_jump_flag;	// <stdin>:1434:10
  assign io_fcex_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1434:10, Mux.scala:101:16
  assign io_fcmem_stall = ~io_fcex_jump_flag & ~io_fcde_jump_flag & io_fcde_load_use;	// <stdin>:1434:10, Mux.scala:101:16
endmodule
...
module Core(	// <stdin>:1566:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      fdreg_pc <= 64'h80000000;	// <stdin>:1595:20, Core.scala:48:24
      dereg_op_a <= 64'h0;	// <stdin>:1600:28, Core.scala:53:24
      dereg_op_b <= 64'h0;	// <stdin>:1600:28, Core.scala:53:24
      dereg_rd <= 5'h0;	// <stdin>:1603:23, Core.scala:53:24
      dereg_branch_type <= 1'h0;	// Core.scala:53:24, :297:19
      dereg_branch_addr <= 64'h0;	// <stdin>:1600:28, Core.scala:53:24
      dereg_alu_op <= 6'h3F;	// <stdin>:1604:27, Core.scala:53:24
      dereg_shamt <= 5'h0;	// <stdin>:1603:23, Core.scala:53:24
      dereg_wb_type <= 2'h0;	// <stdin>:1602:25, Core.scala:53:24
      dereg_sd_type <= 3'h0;	// <stdin>:1599:25, Core.scala:53:24
      dereg_reg2_rdata <= 64'h0;	// <stdin>:1600:28, Core.scala:53:24
      dereg_ld_type <= 3'h0;	// <stdin>:1599:25, Core.scala:53:24
      emreg_alu_res <= 64'h0;	// <stdin>:1600:28, Core.scala:69:24
      emreg_wb_type <= 2'h0;	// <stdin>:1602:25, Core.scala:69:24
      emreg_rd <= 5'h0;	// <stdin>:1603:23, Core.scala:69:24
      emreg_ld_type <= 3'h0;	// <stdin>:1599:25, Core.scala:69:24
      emreg_ld_addr_lowbit <= 3'h0;	// <stdin>:1599:25, Core.scala:69:24
      mwreg_wb_type <= 2'h0;	// <stdin>:1602:25, Core.scala:79:24
      mwreg_wb_data <= 64'h0;	// <stdin>:1600:28, Core.scala:79:24
      mwreg_rd <= 5'h0;	// <stdin>:1603:23, Core.scala:79:24
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:1566:10
    ...
    initial begin	// <stdin>:1566:10
      ...
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:1566:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:1566:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1566:10
        ...
        _RANDOM_3 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_7 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_8 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_9 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_10 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_11 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_12 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_13 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_14 = `RANDOM;	// <stdin>:1566:10
        _RANDOM_15 = `RANDOM;	// <stdin>:1566:10
  ...
  assign io_pc = _fetch_io_pc_bits;	// <stdin>:1566:10, Core.scala:39:23
  assign io_valid = _fetch_io_pc_valid;	// <stdin>:1566:10, Core.scala:39:23
endmodule

// external module TempMem

module Soc(	// <stdin>:1794:10
  input         clock,
                reset,
  output [63:0] io_next_pc);
