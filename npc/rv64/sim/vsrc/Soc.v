...
module Decode(	// <stdin>:810:10
  ...
  assign io_deio_branch_addr = io_fdio_pc + {{52{io_inst_bits[31]}}, io_inst_bits[7], io_inst_bits[30:25],
                io_inst_bits[11:8], 1'h0};	// <stdin>:810:10, Cat.scala:33:92, Decode.scala:86:{39,58,79,88,101}, Mux.scala:81:61
...
module Alu(	// <stdin>:899:10
  ...
  assign io_result = (&io_alu_op) ? 64'h0 : io_alu_op == 6'h27 ? {32'h0, _io_result_T_125[31:0]} : io_alu_op ==
                ...
                _GEN_6[127:64] : _io_result_T_166[63:0];	// <stdin>:899:10, Alu.scala:98:34, :99:34, :103:34, :104:45, :105:{37,47}, :106:{36,46}, :107:40, :108:34, :109:40, :110:34, :111:36, :112:48, :113:48, :114:{43,55}, :116:35, :117:{35,51}, :118:{35,51}, :119:{42,58}, :120:45, :121:{42,59}, :122:46, :123:{42,59}, :124:46, Mux.scala:81:{58,61}
endmodule

module Excute(	// <stdin>:1127:10
  ...
  assign io_emio_alu_res = _alu_io_result;	// <stdin>:1127:10, Excute.scala:32:21
...
module Wb(	// <stdin>:1374:10
  ...
  assign io_rfio_rd = io_mwio_rd;	// <stdin>:1374:10
  assign io_rfio_reg_wen = |io_mwio_wb_type;	// <stdin>:1374:10, Wb.scala:24:40
  assign io_rfio_reg_wdata = io_mwio_wb_data;	// <stdin>:1374:10
  assign io_fwwb_reg_waddr = io_mwio_rd;	// <stdin>:1374:10
  assign io_fwwb_reg_wdata = io_mwio_wb_data;	// <stdin>:1374:10
  assign io_fwwb_reg_we = |io_mwio_wb_type;	// <stdin>:1374:10, Wb.scala:24:40
endmodule

module Regfile(	// <stdin>:1388:10
  input         clock,
  ...
  regs_combMem regs_ext (	// Regfile.scala:32:19
    .R0_addr (io_RfWb_rd),
    .R0_en   (1'h1),	// <stdin>:1388:10
    .R0_clk  (clock),
    .R1_addr (io_RfDe_reg1_raddr),
    .R1_en   (1'h1),	// <stdin>:1388:10
    .R1_clk  (clock),
    .R2_addr (io_RfDe_reg2_raddr),
    .R2_en   (1'h1),	// <stdin>:1388:10
    .R2_clk  (clock),
    .W0_addr (5'h0),	// Regfile.scala:37:9
    .W0_en   (1'h1),	// <stdin>:1388:10
    .W0_clk  (clock),
    .W0_data (64'h0),	// Regfile.scala:37:13
    .W1_addr (io_RfWb_rd),
    .W1_en   (1'h1),	// <stdin>:1388:10
    .W1_clk  (clock),
  ...
  assign io_RfDe_reg1_rdata = (|io_RfDe_reg1_raddr) ? _regs_ext_R1_data : 64'h0;	// <stdin>:1388:10, Regfile.scala:32:19, :37:13, :48:{30,50}
  assign io_RfDe_reg2_rdata = (|io_RfDe_reg2_raddr) ? _regs_ext_R2_data : 64'h0;	// <stdin>:1388:10, Regfile.scala:32:19, :37:13, :49:{30,50}
endmodule

module FlowControl(	// <stdin>:1411:10
  ...
  assign io_fcfe_flush = io_fcde_jump_flag;	// <stdin>:1411:10
endmodule

module Forward(	// <stdin>:1467:10
  ...
  assign io_fwde_fw_sel1 = reg1_ex_hazard | reg1_mem_hazard | reg1_wb_hazard;	// <stdin>:1467:10, Forward.scala:38:73, :41:75, :44:73, :47:57
  assign io_fwde_fw_sel2 = reg2_ex_hazard | reg2_mem_hazard | reg2_wb_hazard;	// <stdin>:1467:10, Forward.scala:39:73, :42:75, :45:73, :48:57
  assign io_fwde_fw_data1 = reg1_ex_hazard ? io_fwex_reg_wdata : reg1_mem_hazard ? io_fwmem_reg_wdata : reg1_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:1467:10, Forward.scala:38:73, :41:75, :44:73, Mux.scala:101:16
  assign io_fwde_fw_data2 = reg2_ex_hazard ? io_fwex_reg_wdata : reg2_mem_hazard ? io_fwmem_reg_wdata : reg2_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:1467:10, Forward.scala:39:73, :42:75, :45:73, Mux.scala:101:16
endmodule

// external module DebugInterface

module Core(	// <stdin>:1526:10
  input         clock,
                reset,
  input  [63:0] io_inst,
                io_rdata,
  ...
  always @(posedge clock) begin
    if (reset) begin
      fdreg_pc <= 64'h80000000;	// <stdin>:1555:20, Core.scala:48:24
      dereg_op_a <= 64'h0;	// <stdin>:1560:28, Core.scala:53:24
      dereg_op_b <= 64'h0;	// <stdin>:1560:28, Core.scala:53:24
      dereg_rd <= 5'h0;	// <stdin>:1563:23, Core.scala:53:24
      dereg_branch_type <= 1'h0;	// Core.scala:53:24, :296:19
      dereg_branch_addr <= 64'h0;	// <stdin>:1560:28, Core.scala:53:24
      dereg_alu_op <= 6'h3F;	// <stdin>:1564:27, Core.scala:53:24
      dereg_shamt <= 5'h0;	// <stdin>:1563:23, Core.scala:53:24
      dereg_wb_type <= 2'h0;	// <stdin>:1562:25, Core.scala:53:24
      dereg_sd_type <= 3'h0;	// <stdin>:1559:25, Core.scala:53:24
      dereg_reg2_rdata <= 64'h0;	// <stdin>:1560:28, Core.scala:53:24
      dereg_ld_type <= 3'h0;	// <stdin>:1559:25, Core.scala:53:24
      emreg_alu_res <= 64'h0;	// <stdin>:1560:28, Core.scala:69:24
      emreg_wb_type <= 2'h0;	// <stdin>:1562:25, Core.scala:69:24
      emreg_rd <= 5'h0;	// <stdin>:1563:23, Core.scala:69:24
      emreg_ld_type <= 3'h0;	// <stdin>:1559:25, Core.scala:69:24
      emreg_ld_addr_lowbit <= 3'h0;	// <stdin>:1559:25, Core.scala:69:24
      mwreg_wb_type <= 2'h0;	// <stdin>:1562:25, Core.scala:79:24
      mwreg_wb_data <= 64'h0;	// <stdin>:1560:28, Core.scala:79:24
      mwreg_rd <= 5'h0;	// <stdin>:1563:23, Core.scala:79:24
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:1526:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1526:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1526:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:1526:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:1526:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1526:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1526:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1526:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_3 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_7 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_8 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_9 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_10 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_11 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_12 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_13 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_14 = `RANDOM;	// <stdin>:1526:10
        _RANDOM_15 = `RANDOM;	// <stdin>:1526:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1526:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1526:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_pc = _fetch_io_pc_bits;	// <stdin>:1526:10, Core.scala:39:23
  assign io_valid = _fetch_io_pc_valid;	// <stdin>:1526:10, Core.scala:39:23
endmodule

// external module TempMem

module Soc(	// <stdin>:1749:10
  input         clock,
                reset,
  output [63:0] io_next_pc);
