...
module Forward(	// <stdin>:1469:10
  ...
  assign io_fwde_fw_sel1 = reg1_ex_hazard | reg1_mem_hazard | reg1_wb_hazard;	// <stdin>:1469:10, Forward.scala:38:73, :41:75, :44:73, :47:57
  assign io_fwde_fw_sel2 = reg2_ex_hazard | reg2_mem_hazard | reg2_wb_hazard;	// <stdin>:1469:10, Forward.scala:39:73, :42:75, :45:73, :48:57
  assign io_fwde_fw_data1 = reg1_ex_hazard ? io_fwex_reg_wdata : reg1_mem_hazard ? io_fwmem_reg_wdata : reg1_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:1469:10, Forward.scala:38:73, :41:75, :44:73, Mux.scala:101:16
  assign io_fwde_fw_data2 = reg2_ex_hazard ? io_fwex_reg_wdata : reg2_mem_hazard ? io_fwmem_reg_wdata : reg2_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:1469:10, Forward.scala:39:73, :42:75, :45:73, Mux.scala:101:16
endmodule

// external module DebugInterface

module Core(	// <stdin>:1528:10
  input         clock,
                reset,
  input  [63:0] io_inst,
                io_rdata,
  ...
  always @(posedge clock) begin
    if (reset) begin
      fdreg_pc <= 64'h80000000;	// <stdin>:1557:20, Core.scala:48:24
      dereg_op_a <= 64'h0;	// <stdin>:1562:28, Core.scala:53:24
      dereg_op_b <= 64'h0;	// <stdin>:1562:28, Core.scala:53:24
      dereg_rd <= 5'h0;	// <stdin>:1565:23, Core.scala:53:24
      dereg_branch_type <= 1'h0;	// Core.scala:53:24, :296:19
      dereg_branch_addr <= 64'h0;	// <stdin>:1562:28, Core.scala:53:24
      dereg_alu_op <= 6'h3F;	// <stdin>:1566:27, Core.scala:53:24
      dereg_shamt <= 5'h0;	// <stdin>:1565:23, Core.scala:53:24
      dereg_wb_type <= 2'h0;	// <stdin>:1564:25, Core.scala:53:24
      dereg_sd_type <= 3'h0;	// <stdin>:1561:25, Core.scala:53:24
      dereg_reg2_rdata <= 64'h0;	// <stdin>:1562:28, Core.scala:53:24
      dereg_ld_type <= 3'h0;	// <stdin>:1561:25, Core.scala:53:24
      emreg_alu_res <= 64'h0;	// <stdin>:1562:28, Core.scala:69:24
      emreg_wb_type <= 2'h0;	// <stdin>:1564:25, Core.scala:69:24
      emreg_rd <= 5'h0;	// <stdin>:1565:23, Core.scala:69:24
      emreg_ld_type <= 3'h0;	// <stdin>:1561:25, Core.scala:69:24
      emreg_ld_addr_lowbit <= 3'h0;	// <stdin>:1561:25, Core.scala:69:24
      mwreg_wb_type <= 2'h0;	// <stdin>:1564:25, Core.scala:79:24
      mwreg_wb_data <= 64'h0;	// <stdin>:1562:28, Core.scala:79:24
      mwreg_rd <= 5'h0;	// <stdin>:1565:23, Core.scala:79:24
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:1528:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1528:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1528:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:1528:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:1528:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1528:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1528:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1528:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_3 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_7 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_8 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_9 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_10 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_11 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_12 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_13 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_14 = `RANDOM;	// <stdin>:1528:10
        _RANDOM_15 = `RANDOM;	// <stdin>:1528:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1528:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1528:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_pc = _fetch_io_pc_bits;	// <stdin>:1528:10, Core.scala:39:23
  assign io_valid = _fetch_io_pc_valid;	// <stdin>:1528:10, Core.scala:39:23
endmodule

// external module TempMem

module Soc(	// <stdin>:1751:10
  input         clock,
                reset,
  output [63:0] io_next_pc);
