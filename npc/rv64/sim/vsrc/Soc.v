...
module BoothMul(	// <stdin>:1091:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _T_2;	// BoothMul.scala:114:31
      automatic logic _GEN;	// BoothMul.scala:30:28, :55:18, :114:41
      _T_2 = shiftCounter == total;	// BoothMul.scala:52:31, :53:24, :114:31
      _GEN = state & _T_2;	// BoothMul.scala:30:28, :47:24, :55:18, :114:{31,41}
      ...
      if (state) begin	// BoothMul.scala:47:24
        ...
        _GEN_0 = ~state | _T_2;	// BoothMul.scala:45:28, :47:24, :55:18, :114:{31,41}
        ...
        state <= (~state | ~_T_2) & state;	// BoothMul.scala:47:24, :55:18, :114:{31,41}, :115:23
        if (_GEN_0) begin	// BoothMul.scala:45:28, :55:18, :114:41
        end
        ...
        state <= io_mul_valid | state;	// BoothMul.scala:47:24, :64:31, :65:23
        shiftCounter <= 6'h0;	// BoothMul.scala:52:31
        if (io_mul_valid) begin
...
module Alu(	// <stdin>:1264:10
  ...
  BoothMul BM (	// Alu.scala:84:20
    ...
    .io_mul_signed   (_T_8 ? (_res_T_174 | _res_T_176 | _res_T_208 ? 2'h3 : {_res_T_178, 1'h0}) : 2'h0),	// <stdin>:1264:10, Alu.scala:98:22, :103:{20,45,71}, :104:{34,46,61}, :108:30, :111:21, Mux.scala:101:16
  ...
  assign io_result = _BM_io_out_valid ? (_res_T_174 | _res_T_208 ? _BM_io_result_lo : _res_T_176 | _res_T_178 |
                ...
                _res_T_180 ? _GEN_9[127:64] : _res_T_179[63:0];	// <stdin>:1264:10, Alu.scala:84:20, :103:{20,45,71}, :104:{19,46}, :123:42, :124:73, :131:15, :149:38, :154:38, :157:{40,50}, :158:44, :159:38, :160:44, :161:38, :163:52, :164:46, :165:53, :167:39, :168:{39,55}, :169:45, :170:52, :171:49, :172:{46,63}, :173:50, :174:{46,63}, :175:50, :177:{31,40}, Mux.scala:81:{58,61}, :101:16
  assign io_mul_div_outvalid = _BM_io_out_valid;	// <stdin>:1264:10, Alu.scala:84:20
endmodule

module Excute(	// <stdin>:1564:10
  input         clock,
                reset,
  ...
  wire [1:0]  _GEN = {1'h0, io_deio_sd_type == 3'h1};	// <stdin>:1564:10, Mux.scala:81:{58,61}
  ...
  always @(posedge clock) begin
    if (reset) begin
      aluvalid_buffer <= 1'h0;	// <stdin>:1564:10, Excute.scala:44:34
  ...
  `ifndef SYNTHESIS	// <stdin>:1564:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1564:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1564:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1564:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1564:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1564:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1564:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1564:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1564:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1564:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1564:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1564:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1564:10
        aluvalid_buffer = _RANDOM_0[0];	// Excute.scala:44:34
        alu_buffer = {_RANDOM_0[31:1], _RANDOM_1, _RANDOM_2[0]};	// Excute.scala:44:34, :45:29
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1564:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1564:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_emio_reg_wdata = io_deio_csr_wen ? io_deio_csr_t : _mul_div_type_T_4 ? _io_fwex_reg_wdata_T_1 :
                _alu_io_result;	// <stdin>:1564:10, Excute.scala:36:21, :61:91, :76:32, Mux.scala:101:16
  assign io_emio_reg_waddr = io_deio_reg_waddr;	// <stdin>:1564:10
  assign io_emio_wb_type = io_deio_wb_type;	// <stdin>:1564:10
  assign io_emio_ld_type = io_deio_ld_type;	// <stdin>:1564:10
  assign io_emio_ld_addr_lowbit = _io_raddr_T_3[2:0];	// <stdin>:1564:10, Excute.scala:85:39, :102:20
  assign io_emio_csr_wdata = _alu_io_result;	// <stdin>:1564:10, Excute.scala:36:21
  assign io_emio_csr_wen = io_deio_csr_wen;	// <stdin>:1564:10
  assign io_emio_csr_waddr = io_deio_csr_waddr;	// <stdin>:1564:10
  assign io_emio_has_inst = io_deio_has_inst;	// <stdin>:1564:10
  assign io_fcex_jump_flag = io_deio_branch_type & (|_alu_io_result);	// <stdin>:1564:10, Excute.scala:36:21, :95:{55,74}
  assign io_fcex_jump_pc = io_deio_branch_addr[31:0];	// <stdin>:1564:10, Excute.scala:96:21
  assign io_fcex_mul_div = _mul_div_type_T_4;	// <stdin>:1564:10, Excute.scala:61:91
  assign io_fcex_mul_div_valid = _alu_io_mul_div_outvalid;	// <stdin>:1564:10, Excute.scala:36:21
  assign io_raddr = _io_raddr_T_3;	// <stdin>:1564:10, Excute.scala:102:20
  assign io_waddr = (|io_deio_sd_type) & ~_CLINT_type_T_6 ? _alu_io_result : 64'h0;	// <stdin>:1564:10, Excute.scala:36:21, :45:29, :68:63, :69:42, :102:63, :104:{20,47}
  assign io_wdata = io_deio_reg2_rdata;	// <stdin>:1564:10
  assign io_wmask = _io_clex_wmask_T_6 ? 8'hFF : {4'h0, _io_clex_wmask_T_4 ? 4'hF : {2'h0, _io_clex_wmask_T_2 ?
                2'h3 : _GEN}};	// <stdin>:1564:10, Mux.scala:81:{58,61}
  assign io_cl_type = _CLINT_type_T_6;	// <stdin>:1564:10, Excute.scala:69:42
  assign io_fwex_reg_waddr = io_deio_reg_waddr;	// <stdin>:1564:10
  assign io_fwex_reg_wdata = _io_fwex_reg_wdata_T ? (_mul_div_type_T_4 ? _io_fwex_reg_wdata_T_1 : _alu_io_result) :
                (&io_deio_wb_type) ? io_deio_csr_t : 64'h0;	// <stdin>:1564:10, Excute.scala:36:21, :45:29, :61:91, :76:32, :136:{40,70}, Mux.scala:101:16
  assign io_fwex_reg_we = _io_fwex_reg_wdata_T | (&io_deio_wb_type);	// <stdin>:1564:10, Excute.scala:136:{40,51,70}
  assign io_fwex_csr_wdata = _alu_io_result;	// <stdin>:1564:10, Excute.scala:36:21
  assign io_fwex_csr_wen = io_deio_csr_wen;	// <stdin>:1564:10
  assign io_fwex_csr_waddr = io_deio_csr_waddr;	// <stdin>:1564:10
  assign io_clex_valid = _CLINT_type_T_6;	// <stdin>:1564:10, Excute.scala:69:42
  assign io_clex_ld_type = io_deio_ld_type;	// <stdin>:1564:10
  assign io_clex_raddr = _alu_io_result;	// <stdin>:1564:10, Excute.scala:36:21
  assign io_clex_sd_type = io_deio_sd_type;	// <stdin>:1564:10
  assign io_clex_waddr = _alu_io_result;	// <stdin>:1564:10, Excute.scala:36:21
  assign io_clex_wmask = _io_clex_wmask_T_6 ? 8'hFF : {4'h0, _io_clex_wmask_T_4 ? 4'hF : {2'h0, _io_clex_wmask_T_2 ?
                2'h3 : _GEN}};	// <stdin>:1564:10, Mux.scala:81:{58,61}
  assign io_clex_wdata = io_deio_reg2_rdata;	// <stdin>:1564:10
endmodule

module Mem(	// <stdin>:1693:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:1693:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1693:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1693:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1693:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1693:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1693:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1693:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1693:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1693:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1693:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1693:10
        _RANDOM_3 = `RANDOM;	// <stdin>:1693:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1693:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1693:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1693:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1693:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1693:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_mwio_reg_wdata = _io_fwmem_reg_wdata_T | (&io_emio_wb_type) ? io_emio_reg_wdata : _io_fwmem_reg_wdata_T_3 ?
                rvalue : 64'h0;	// <stdin>:1693:10, Mem.scala:33:31, :149:{30,41,60}, :150:30, Mux.scala:101:16
  assign io_mwio_reg_waddr = io_emio_reg_waddr;	// <stdin>:1693:10
  assign io_mwio_wb_type = io_emio_wb_type;	// <stdin>:1693:10
  assign io_mwio_csr_wdata = io_emio_csr_wdata;	// <stdin>:1693:10
  assign io_mwio_csr_wen = io_emio_csr_wen;	// <stdin>:1693:10
  assign io_mwio_csr_waddr = io_emio_csr_waddr;	// <stdin>:1693:10
  assign io_mwio_has_inst = io_emio_has_inst;	// <stdin>:1693:10
  assign io_fwmem_reg_waddr = io_emio_reg_waddr;	// <stdin>:1693:10
  assign io_fwmem_reg_wdata = _io_fwmem_reg_wdata_T | (&io_emio_wb_type) ? io_emio_reg_wdata : _io_fwmem_reg_wdata_T_3 ?
                rvalue : 64'h0;	// <stdin>:1693:10, Mem.scala:33:31, :149:{30,60}, :150:30, :164:41, Mux.scala:101:16
  assign io_fwmem_reg_we = |io_emio_wb_type;	// <stdin>:1693:10, Mem.scala:161:40
  assign io_fwmem_csr_wdata = io_emio_csr_wdata;	// <stdin>:1693:10
  assign io_fwmem_csr_wen = io_emio_csr_wen;	// <stdin>:1693:10
  assign io_fwmem_csr_waddr = io_emio_csr_waddr;	// <stdin>:1693:10
endmodule

module Wb(	// <stdin>:1958:10
  ...
  assign io_rfio_rd = io_mwio_reg_waddr;	// <stdin>:1958:10
  assign io_rfio_reg_wen = ~io_stall & (|io_mwio_wb_type);	// <stdin>:1958:10, Wb.scala:32:{27,59}
  assign io_rfio_reg_wdata = io_mwio_reg_wdata;	// <stdin>:1958:10
  assign io_fwwb_reg_waddr = io_mwio_reg_waddr;	// <stdin>:1958:10
  assign io_fwwb_reg_wdata = io_mwio_reg_wdata;	// <stdin>:1958:10
  assign io_fwwb_reg_we = |io_mwio_wb_type;	// <stdin>:1958:10, Wb.scala:32:59
  assign io_fwwb_csr_wdata = io_mwio_csr_wdata;	// <stdin>:1958:10
  assign io_fwwb_csr_wen = io_mwio_csr_wen;	// <stdin>:1958:10
  assign io_fwwb_csr_waddr = io_mwio_csr_waddr;	// <stdin>:1958:10
  assign io_csrs_rd = io_mwio_csr_waddr;	// <stdin>:1958:10
  assign io_csrs_csr_wen = ~io_stall & io_mwio_csr_wen;	// <stdin>:1958:10, Wb.scala:32:27, :47:27
  assign io_csrs_csr_wdata = io_mwio_csr_wdata;	// <stdin>:1958:10
endmodule

module CLINT(	// <stdin>:1982:10
  input         clock,
                reset,
                io_clex_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:1982:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_clmem_Clrvalue_valid = valid_buf;	// <stdin>:1982:10, CLINT.scala:39:28
  assign io_clmem_Clrvalue_bits = rvalue_buf;	// <stdin>:1982:10, CLINT.scala:38:29
  assign io_timer_int = MTIME >= MTIMECMP;	// <stdin>:1982:10, CLINT.scala:34:27, :35:24, :140:28
endmodule

module Forward(	// <stdin>:2113:10
  ...
  assign io_fwde_fw_sel1 = reg1_ex_hazard | reg1_mem_hazard | reg1_wb_hazard;	// <stdin>:2113:10, Forward.scala:46:73, :49:75, :52:73, :55:57
  assign io_fwde_fw_sel2 = reg2_ex_hazard | reg2_mem_hazard | reg2_wb_hazard;	// <stdin>:2113:10, Forward.scala:47:73, :50:75, :53:73, :56:57
  assign io_fwde_fw_data1 = reg1_ex_hazard ? io_fwex_reg_wdata : reg1_mem_hazard ? io_fwmem_reg_wdata : reg1_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:2113:10, Forward.scala:46:73, :49:75, :52:73, Mux.scala:101:16
  assign io_fwde_fw_data2 = reg2_ex_hazard ? io_fwex_reg_wdata : reg2_mem_hazard ? io_fwmem_reg_wdata : reg2_wb_hazard
                ? io_fwwb_reg_wdata : 64'h0;	// <stdin>:2113:10, Forward.scala:47:73, :50:75, :53:73, Mux.scala:101:16
  assign io_fwde_csr_fw_sel = csr_ex_harzard | csr_mem_harzard | csr_wb_harzard;	// <stdin>:2113:10, Forward.scala:74:42, :75:44, :76:42, :78:60
  assign io_fwde_csr_fw_data = csr_ex_harzard ? io_fwex_csr_wdata : csr_mem_harzard ? io_fwmem_csr_wdata : csr_wb_harzard
                ? io_fwwb_csr_wdata : 64'h0;	// <stdin>:2113:10, Forward.scala:74:42, :75:44, :76:42, Mux.scala:101:16
endmodule

module Regfile(	// <stdin>:2170:10
  input         clock,
  ...
  regs_combMem regs_ext (	// Regfile.scala:32:19
    .R0_addr (io_RfWb_rd),
    .R0_en   (1'h1),	// <stdin>:2170:10
    .R0_clk  (clock),
    .R1_addr (io_RfDe_reg1_raddr),
    .R1_en   (1'h1),	// <stdin>:2170:10
    .R1_clk  (clock),
    .R2_addr (io_RfDe_reg2_raddr),
    .R2_en   (1'h1),	// <stdin>:2170:10
    .R2_clk  (clock),
    .W0_addr (5'h0),	// Regfile.scala:37:9
    .W0_en   (1'h1),	// <stdin>:2170:10
    .W0_clk  (clock),
    .W0_data (64'h0),	// Regfile.scala:37:13
    .W1_addr (io_RfWb_rd),
    .W1_en   (1'h1),	// <stdin>:2170:10
    .W1_clk  (clock),
  ...
  assign io_RfDe_reg1_rdata = (|io_RfDe_reg1_raddr) ? _regs_ext_R1_data : 64'h0;	// <stdin>:2170:10, Regfile.scala:32:19, :37:13, :48:{30,50}
  assign io_RfDe_reg2_rdata = (|io_RfDe_reg2_raddr) ? _regs_ext_R2_data : 64'h0;	// <stdin>:2170:10, Regfile.scala:32:19, :37:13, :49:{30,50}
endmodule

module FlowControl(	// <stdin>:2193:10
  ...
  wire Icache_stall;	// <stdin>:2198:5
  wire Dcache_stall;	// <stdin>:2200:5
  wire IO_stall;	// <stdin>:2202:5
  wire MULDIV_stall;	// <stdin>:2204:5
  ...
  wire SFBundle_4 = IO_stall | Icache_stall | Dcache_stall | ~io_fcde_load_use & ~_SFBundle_T_3 &
                ~_SFBundle_T_14 & ~io_fctr_jump_flag & ~io_fcex_jump_flag & ~io_fcde_jump_flag &
                MULDIV_stall;	// FlowControl.scala:204:47, :206:87, Mux.scala:101:16
  assign io_fcfe_jump_flag = io_fcde_jump_flag | io_fcex_jump_flag | io_fctr_jump_flag;	// <stdin>:2193:10, FlowControl.scala:227:65
  assign io_fcfe_jump_pc = io_fctr_jump_flag ? io_fctr_jump_pc : io_fcex_jump_flag ? io_fcex_jump_pc :
                io_fcde_jump_flag ? io_fcde_jump_pc : 32'h80000000;	// <stdin>:2193:10, Mux.scala:101:16
  assign io_fcfe_flush = ~IO_stall & ~Icache_stall & ~Dcache_stall & ~io_fcde_load_use & (_SFBundle_T_3 |
                ~_SFBundle_T_14 & (io_fctr_jump_flag | io_fcex_jump_flag | io_fcde_jump_flag));	// <stdin>:2193:10, FlowControl.scala:204:47, :206:87, Mux.scala:101:16
  assign io_fcfe_stall = SFBundle_0;	// <stdin>:2193:10, Mux.scala:101:16
  assign io_fcde_flush = ~IO_stall & ~Icache_stall & ~Dcache_stall & (io_fcde_load_use | _SFBundle_T_3 |
                _SFBundle_T_14 | ~io_fctr_jump_flag & io_fcex_jump_flag);	// <stdin>:2193:10, FlowControl.scala:204:47, :206:87, Mux.scala:101:16
  assign io_fcde_stall = SFBundle_1;	// <stdin>:2193:10, Mux.scala:101:16
  assign io_fcex_stall = SFBundle_2;	// <stdin>:2193:10, Mux.scala:101:16
  assign io_fcmem_stall = IO_stall | Icache_stall | Dcache_stall | ~io_fcde_load_use & ~_SFBundle_T_3 &
                ~_SFBundle_T_14 & ~io_fctr_jump_flag & ~io_fcex_jump_flag & ~io_fcde_jump_flag &
                MULDIV_stall;	// <stdin>:2193:10, FlowControl.scala:204:47, :206:87, Mux.scala:101:16
  assign io_fcwb_stall = SFBundle_4;	// <stdin>:2193:10, Mux.scala:101:16
  assign io_fcio_stall = SFBundle_2;	// <stdin>:2193:10, Mux.scala:101:16
  assign io_sdb_stall = SFBundle_0 & SFBundle_1 & SFBundle_2 & SFBundle_4;	// <stdin>:2193:10, FlowControl.scala:241:67, Mux.scala:101:16
endmodule

module CSRs(	// <stdin>:2461:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:2461:10
    ...
    initial begin	// <stdin>:2461:10
      ...
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2461:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2461:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2461:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2461:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2461:10
        ...
        _RANDOM_10 = `RANDOM;	// <stdin>:2461:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2461:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2461:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2461:10
  ...
  assign io_CSRDe_csr_rdata = io_CSRDe_csr_raddr == 12'h340 ? MSCRATCH : io_CSRDe_csr_raddr == 12'h300 ? MSTATUS :
                ...
                MTVEC : 64'h0;	// <stdin>:2461:10, CSRs.scala:43:24, :44:25, :45:23, :46:22, :48:26, :49:27, :56:38, Mux.scala:81:{58,61}
  assign io_CSRTr_MTVEC = MTVEC;	// <stdin>:2461:10, CSRs.scala:43:24
  assign io_CSRTr_MCAUSE = MCAUSE;	// <stdin>:2461:10, CSRs.scala:44:25
  assign io_CSRTr_MEPC = MEPC;	// <stdin>:2461:10, CSRs.scala:45:23
  assign io_CSRTr_MIE = MIE;	// <stdin>:2461:10, CSRs.scala:46:22
  assign io_CSRTr_MIP = MIP;	// <stdin>:2461:10, CSRs.scala:47:22
  assign io_CSRTr_MSTATUS = MSTATUS;	// <stdin>:2461:10, CSRs.scala:48:26
endmodule

module Trap(	// <stdin>:2550:10
  input         clock,
                reset,
                io_ex_hasinst,
                io_mem_hasinst,
  ...
  `ifndef SYNTHESIS	// <stdin>:2550:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2550:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2550:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2550:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2550:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2550:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2550:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2550:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2550:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2550:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2550:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2550:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2550:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2550:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2550:10
        cause = {_RANDOM_0, _RANDOM_1};	// Trap.scala:45:24
        pc = _RANDOM_2;	// Trap.scala:46:21
        state = _RANDOM_3[2:0];	// Trap.scala:48:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2550:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2550:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_csrtr_rd = _GEN_0[state];	// <stdin>:2550:10, Trap.scala:48:24, :61:17, :64:18, :69:25, :106:25, :113:25, :121:25, :131:36, :145:25
  assign io_csrtr_csr_wen = ~_T & state != 3'h1 & (state == 3'h2 | state == 3'h3 | state == 3'h4 | state != 3'h5 &
                (state == 3'h6 ? _T_24 : (&state)));	// <stdin>:2550:10, Trap.scala:48:24, :59:22, :64:18, :68:30, :79:23, :83:23, :100:23, :105:30, :108:19, :115:19, :127:23, :131:36
  assign io_csrtr_csr_wdata = _GEN[state];	// <stdin>:2550:10, Trap.scala:48:24, :58:24, :64:18, :67:32, :104:32, :111:32, :119:32, :131:36, :143:32
  assign io_fctr_pop_NOP = _T & (_T_2 | _T_3 | _T_7);	// <stdin>:2550:10, Trap.scala:62:21, :64:18, :71:{57,74}, :78:33, :80:{32,62}, :85:57
  assign io_fctr_trap_state = state;	// <stdin>:2550:10, Trap.scala:48:24
  assign io_fctr_jump_flag = _T_26 | (&state);	// <stdin>:2550:10, Trap.scala:48:24, :154:18, :156:31
  assign io_fctr_jump_pc = _T_26 ? io_csrtr_MTVEC[31:0] : (&state) ? io_csrtr_MEPC[31:0] : 32'h0;	// <stdin>:2550:10, Trap.scala:46:21, :48:24, :153:21, :154:18, :157:29, :161:29
endmodule

module AXIArbitor(	// <stdin>:2684:10
  input         clock,
                reset,
  ...
  always @(posedge clock) begin
    if (reset) begin
      choose_buffer <= 4'h0;	// <stdin>:2690:22, AXIArbitor.scala:59:32
  ...
  `ifndef SYNTHESIS	// <stdin>:2684:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_master0_resp_valid = ~_T & (_T_2 ? _T_4 & choose_buffer[0] : ~_T_7 & (&state) & _GEN_6 & choose_buffer[0]);	// <stdin>:2684:10, AXIArbitor.scala:59:32, :84:30, :125:24, :139:12, :141:27, :148:23, :162:22, :166:18, :197:{36,46}, :202:39
  assign io_master0_resp_bits_data = _GEN_7[state];	// <stdin>:2684:10, AXIArbitor.scala:125:24, :142:31, :166:18
  assign io_master1_resp_valid = ~_T & (_T_2 ? _T_4 & _GEN_2 : ~_T_7 & (&state) & _GEN_6 & _GEN_2);	// <stdin>:2684:10, AXIArbitor.scala:125:24, :139:12, :143:27, :148:23, :162:22, :166:18, :197:{36,46}, :202:39, :204:45
  assign io_master1_resp_bits_data = _GEN_8[state];	// <stdin>:2684:10, AXIArbitor.scala:125:24, :144:31, :166:18
  assign io_master2_resp_valid = ~_T & (_T_2 ? _T_4 & _GEN_3 : ~_T_7 & (&state) & _GEN_6 & _GEN_3);	// <stdin>:2684:10, AXIArbitor.scala:125:24, :139:12, :145:27, :148:23, :162:22, :166:18, :197:{36,46}, :202:39, :204:45
  assign io_master2_resp_bits_data = _GEN_9[state];	// <stdin>:2684:10, AXIArbitor.scala:125:24, :146:31, :166:18
  assign io_AXI_O_aw_valid = _GEN;	// <stdin>:2684:10, AXIArbitor.scala:148:23, :166:18
  assign io_AXI_O_aw_bits_addr = _GEN_0 ? 32'h0 : _addr_T_6;	// <stdin>:2684:10, AXIArbitor.scala:149:27, :166:18, Mux.scala:101:16
  assign io_AXI_O_w_valid = _GEN_1;	// <stdin>:2684:10, AXIArbitor.scala:152:22, :166:18
  assign io_AXI_O_w_bits_data = _GEN_0 ? 64'h0 : choose_buffer[0] ? io_master0_req_bits_data : choose_buffer[1] ?
                io_master1_req_bits_data : choose_buffer[2] ? io_master2_req_bits_data : 64'h0;	// <stdin>:2684:10, AXIArbitor.scala:59:32, :84:30, :85:30, :86:30, :149:27, :153:26, :166:18, Mux.scala:101:16
  assign io_AXI_O_w_bits_strb = _GEN_0 ? 8'h0 : choose_buffer[0] ? io_master0_req_bits_mask : choose_buffer[1] ?
                io_master1_req_bits_mask : choose_buffer[2] ? io_master2_req_bits_mask : 8'h0;	// <stdin>:2684:10, AXIArbitor.scala:59:32, :84:30, :85:30, :86:30, :149:27, :154:26, :166:18, Mux.scala:101:16
  assign io_AXI_O_ar_valid = _GEN_4;	// <stdin>:2684:10, AXIArbitor.scala:158:23, :166:18
  assign io_AXI_O_ar_bits_addr = _T | _T_2 | ~(_T_7 & choose_buffer[3]) ? 32'h0 : _addr_T_6;	// <stdin>:2684:10, AXIArbitor.scala:59:32, :80:28, :159:27, :166:18, :214:35, Mux.scala:101:16
  assign io_AXI_O_r_ready = _GEN_5;	// <stdin>:2684:10, AXIArbitor.scala:162:22, :166:18
endmodule

module Cache(	// <stdin>:2863:10, :3924:10
  input         clock,
                reset,
                io_cpu_req_valid,
  ...
  wire              _GEN;	// <stdin>:2936:18, :3997:18, Cache.scala:174:18
  ...
  wire              hit0;	// <stdin>:2884:5, :3945:5
  wire              hit1;	// <stdin>:2886:5, :3947:5
  wire [511:0]      _hit0_T_7 = valid >> {503'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:71:24, :91:{43,100}
  assign hit0 = _TagArray_ext_R4_data == io_cpu_req_bits_addr[31:11] & _hit0_T_7[0];	// Cache.scala:75:23, :91:{10,58,82,92,100}
  wire [9:0]        _GEN_0 = {1'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:91:43, :92:141
  ...
  wire [31:0]       _GEN_1 = {23'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:91:43, :201:46
  wire [1023:0]     _GEN_2 = {1015'h0, io_cpu_req_bits_addr[10:3], 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:91:43, :247:55
  ...
  wire              _GEN_3 = ~io_cpu_req_valid | (|io_cpu_req_bits_mask) | ~_T_3;	// <stdin>:2932:14, :3993:14, Cache.scala:133:28, :183:35, :185:{43,47}, :222:38
  ...
  wire [511:0]      _GEN_4 = {503'h0, index, 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :91:100, :291:40
  wire [511:0]      _replace_wire_T_1 = replace >> _GEN_4;	// Cache.scala:73:26, :291:40
  wire [9:0]        _GEN_5 = {1'h0, index, 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :294:34
  wire [9:0]        _GEN_6 = {9'h0, _GEN};	// <stdin>:2936:18, :3997:18, Cache.scala:174:18, :294:34
  wire [511:0]      _T_8 = dirty >> _GEN_5 + _GEN_6;	// Cache.scala:72:24, :294:{23,34}
  wire [8:0]        _GEN_7 = {index, 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :294:34
  wire [8:0]        _GEN_8 = {8'h0, _GEN};	// <stdin>:2936:18, :3997:18, Cache.scala:124:23, :174:18, :294:34
  ...
  wire [1023:0]     _GEN_11 = {1015'h0, index, 1'h0};	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :247:55, :352:47
  ...
  assign _GEN = ~_T & (_T_4 ? _replace_wire_T_1[0] : ~_T_10 & ~(&state) & ~_T_25 & _T_200 &
                _replace_wire_T_5[0]);	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :77:32, :174:18, :291:{26,40}, :490:40
  ...
  assign DataOneArrayRen = _T ? io_cpu_req_valid & _T_3 : _T_4 ? _T_8[0] : _T_10 | ~(&state) & ~_T_25 & (_T_200 ?
                _T_204[0] : _T_206);	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :77:32, :100:21, :133:28, :174:18, :183:35, :185:47, :294:{23,50}, :322:29, :493:{23,50}
  ...
  wire              _GEN_20 = ~_T & ~_T_4 & ~_T_10 & ~(&state) & ~_T_25 & ~_T_200 & ~_T_206 & _T_207 & _GEN_12;	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :77:32, :119:21, :174:18, :344:36, :349:29
  ...
  wire [7:0][511:0] _GEN_23 = {{io_axi_resp_valid ? (victim ? replace | _replace0_T_17[511:0] : ~(~replace |
                ...
                ? 512'h0 : hit0 ? ~(~replace | _replace0_T_2[511:0]) : replace | _replace0_T_10[511:0]}};	// <stdin>:2932:14, :3993:14, Cache.scala:71:24, :72:24, :73:26, :119:21, :129:26, :133:28, :174:18, :183:35, :185:47, :227:35, :247:{38,55}, :266:{38,55}, :344:36, :349:29, :352:{30,47}, :361:{30,47}, :388:26, :432:{26,43}, :480:{26,43}, :546:29, :549:{30,47}, :600:{30,47}
  wire [511:0]      _GEN_24 = _GEN_23[state];	// <stdin>:2932:14, :3993:14, Cache.scala:64:24, :174:18, :183:35, :344:36, :388:26
  ...
  wire [7:0][511:0] _GEN_25 = {{io_axi_resp_valid ? (victim ? ~(~replace | _replace1_T_23[511:0]) : replace |
                ...
                ? 512'h0 : hit0 ? replace | _replace1_T_4[511:0] : ~(~replace | _replace1_T_14[511:0])}};	// <stdin>:2932:14, :2934:14, :3993:14, :3995:14, Cache.scala:71:24, :72:24, :73:26, :119:21, :129:26, :133:28, :174:18, :183:35, :185:47, :227:35, :248:{38,55}, :266:55, :267:{38,55}, :344:36, :349:29, :352:47, :353:{30,47}, :362:{30,47}, :388:26, :432:43, :433:{26,43}, :481:{26,43}, :546:29, :549:47, :550:{30,47}, :601:{30,47}
  wire [511:0]      _GEN_26 = _GEN_25[state];	// <stdin>:2934:14, :3995:14, Cache.scala:64:24, :174:18, :183:35, :344:36, :388:26
  wire              _GEN_27 = ~_T & ~_T_4 & ~_T_10 & ~(&state) & ~_T_25 & ~_T_200 & ~_T_206 & _T_207 & _GEN_14;	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :77:32, :119:21, :174:18, :344:36, :349:29
  ...
  always @(posedge clock) begin
    ...
    _GEN_29 = _T & io_cpu_req_valid & ((|io_cpu_req_bits_mask) | ~_T_3);	// <stdin>:2932:14, :3993:14, Cache.scala:67:18, :133:28, :174:18, :183:35, :185:{43,47}, :186:38, :222:38
    if (reset) begin
      ...
      inDataOneArray <= 1'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:107:33
      addr <= 32'h0;	// Cache.scala:122:23
      data <= 64'h0;	// Cache.scala:123:23, :147:36
      mask <= 8'h0;	// Cache.scala:124:23
      inst_type <= 1'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:126:28
      whitNum <= 1'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:129:26
      cpu_resp_valid <= 1'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:142:33
      cpu_resp_bits_data <= 64'h0;	// Cache.scala:143:37, :147:36
      axi_req_valid <= 1'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:144:32
      axi_req_bits_rw <= 1'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:145:34
      ...
      _GEN_34 = {{io_axi_resp_valid ? (victim ? _GEN_24 | _GEN_26 : _GEN_24 | _GEN_26) : replace},
                                                ...
                                                : hit0 ? _GEN_24 | _GEN_26 : _GEN_24 | _GEN_26}};	// <stdin>:2932:14, :3993:14, Cache.scala:72:24, :73:26, :119:21, :129:26, :133:28, :174:18, :183:35, :185:47, :227:35, :249:{37,49}, :268:{37,49}, :344:36, :349:29, :354:{29,41}, :363:{29,41}, :388:26, :434:{25,37}, :482:{25,37}, :546:29, :551:{29,41}, :602:{29,41}
      ...
      axi_req_valid <= ~_T & (_T_4 | _T_10 | ((&state) ? ~io_axi_resp_valid : ~_T_25 & (_T_200 | _T_206 | _T_207 &
                                                ~io_axi_resp_valid)));	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :144:32, :171:19, :174:18, :294:50, :321:28, :329:36, :332:32, :344:36, :493:50, :540:36
    ...
    victim <= ~_T & (_T_4 | ~(_T_10 | (&state) | _T_25 | ~_T_200) ? _GEN : victim);	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :119:21, :174:18, :177:20, :292:20
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:2863:10, :3924:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2863:10, :3924:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2863:10, :3924:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_53;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_54;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_55;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_56;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_57;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_58;	// <stdin>:2863:10, :3924:10
      automatic logic [31:0] _RANDOM_59;	// <stdin>:2863:10, :3924:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2863:10, :3924:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2863:10, :3924:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2863:10, :3924:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_15 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_16 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_17 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_18 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_19 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_20 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_21 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_22 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_23 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_24 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_25 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_26 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_27 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_28 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_29 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_30 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_31 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_32 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_33 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_34 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_35 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_36 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_37 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_38 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_39 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_40 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_41 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_42 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_43 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_44 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_45 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_46 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_47 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_48 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_49 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_50 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_51 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_52 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_53 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_54 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_55 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_56 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_57 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_58 = `RANDOM;	// <stdin>:2863:10, :3924:10
        _RANDOM_59 = `RANDOM;	// <stdin>:2863:10, :3924:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2863:10, :3924:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2863:10, :3924:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  TagArray_combMem TagArray_ext (	// Cache.scala:75:23
    ...
    .R2_en   (~_T & ~_T_4 & ~_T_10 & ~(&state) & ~_T_25 & _T_200 & _T_204[0]),	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :77:32, :174:18, :493:23
    .R2_clk  (clock),
    .R3_addr (_GEN_7 + _GEN_9),	// Cache.scala:294:34, :317:57, :515:57
    .R3_en   (~_T & ~_T_4 & ~_T_10 & ~(&state) & ~_T_25 & ~_T_200 & _T_206),	// <stdin>:2936:18, :3997:18, Cache.scala:64:24, :75:23, :77:32, :119:21, :174:18
    .R3_clk  (clock),
    .R4_addr ({io_cpu_req_bits_addr[10:3], 1'h0}),	// <stdin>:2863:10, :3924:10, Cache.scala:91:{22,43}
    .R4_en   (1'h1),	// <stdin>:2863:10, :3924:10
    .R4_clk  (clock),
    .R5_addr ({io_cpu_req_bits_addr[10:3], 1'h0} + 9'h1),	// <stdin>:2863:10, :3924:10, Cache.scala:91:43, :92:57
    .R5_en   (1'h1),	// <stdin>:2863:10, :3924:10
    .R5_clk  (clock),
    .W0_addr (_GEN_7 + 9'h1),	// Cache.scala:92:57, :294:34, :356:42
    .W0_en   (_GEN_13),	// Cache.scala:75:23, :174:18
    .W0_clk  (clock),
    .W0_data (tag),	// Cache.scala:67:18
    .W1_addr ({index, 1'h0}),	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :365:29
    ...
    .W3_addr ({index, 1'h0}),	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :604:29
  ...
  DataArray_combMem DataArray_ext (	// Cache.scala:77:32
    ...
    .W1_addr ({index, 1'h0}),	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :366:30
    .W1_en   (_GEN_15),	// Cache.scala:75:23, :174:18
    .W1_clk  (clock),
    ...
    .W3_addr ({index, 1'h0}),	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :437:26
    ...
    .W5_addr ({index, 1'h0}),	// <stdin>:2863:10, :3924:10, Cache.scala:68:20, :605:30
  ...
  assign io_cpu_resp_valid = cpu_resp_valid;	// <stdin>:2863:10, :3924:10, Cache.scala:142:33
  assign io_cpu_resp_bits_data = inDataOneArray ? (inst_type ? {32'h0, _T_379 ? DataOneArray[31:0] : DataOneArray[63:32]} :
                DataOneArray) : cpu_resp_bits_data;	// <stdin>:2863:10, :3924:10, Cache.scala:107:33, :122:23, :126:28, :143:37, :153:33, :154:{12,27,35,56,76}
  assign io_axi_req_valid = axi_req_valid;	// <stdin>:2863:10, :3924:10, Cache.scala:144:32
  assign io_axi_req_bits_rw = axi_req_bits_rw;	// <stdin>:2863:10, :3924:10, Cache.scala:145:34
  assign io_axi_req_bits_addr = axi_req_bits_addr;	// <stdin>:2863:10, :3924:10, Cache.scala:146:36
  assign io_axi_req_bits_data = inDataOneArray ? DataOneArray : 64'h0;	// <stdin>:2863:10, :3924:10, Cache.scala:107:33, :147:36, :154:56, :163:32
  assign io_axi_req_bits_mask = axi_req_bits_mask;	// <stdin>:2863:10, :3924:10, Cache.scala:148:36
  assign io_fccache_req = io_cpu_req_valid;	// <stdin>:2863:10, :3924:10
  assign io_fccache_state = state;	// <stdin>:2863:10, :3924:10, Cache.scala:64:24
  assign io_fccache_mask = io_cpu_req_bits_mask;	// <stdin>:2863:10, :3924:10
  assign io_fccache_hit = _T_3;	// <stdin>:2863:10, :3924:10, Cache.scala:133:28
  assign io_fccache_cpu_valid = cpu_resp_valid;	// <stdin>:2863:10, :3924:10, Cache.scala:142:33
  assign io_fccache_axi_valid = io_axi_resp_valid;	// <stdin>:2863:10, :3924:10
endmodule

module IoforMem(	// <stdin>:4985:10
  input         clock,
                reset,
                io_axi_resp_valid,
  input  [63:0] io_axi_resp_bits_data,
  ...
  `ifndef SYNTHESIS	// <stdin>:4985:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4985:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4985:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4985:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4985:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4985:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4985:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4985:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4985:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4985:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4985:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4985:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4985:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4985:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4985:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4985:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4985:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4985:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4985:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4985:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4985:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_axi_req_valid = (_T | ~_T_5 | ~io_axi_resp_valid) & axi_req_valid;	// <stdin>:4985:10, IoforMem.scala:50:32, :59:22, :74:18, :91:36, :92:34
  assign io_axi_req_bits_rw = axi_req_bits_rw;	// <stdin>:4985:10, IoforMem.scala:51:34
  assign io_axi_req_bits_addr = axi_req_bits_addr;	// <stdin>:4985:10, IoforMem.scala:52:36
  assign io_axi_req_bits_data = axi_req_bits_data;	// <stdin>:4985:10, IoforMem.scala:53:36
  assign io_axi_req_bits_mask = axi_req_bits_mask;	// <stdin>:4985:10, IoforMem.scala:54:36
  assign io_mem_data_valid = mem_data_valid;	// <stdin>:4985:10, IoforMem.scala:56:33
  assign io_mem_data_bits = mem_data_bits;	// <stdin>:4985:10, IoforMem.scala:57:32
  assign io_fc_req = _T_1 & _axi_req_bits_addr_T > 32'h9FFFFFFF;	// <stdin>:4985:10, IoforMem.scala:69:{34,53,74,93}
  assign io_fc_state = state;	// <stdin>:4985:10, IoforMem.scala:47:24
endmodule
...
module Core(	// <stdin>:5084:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      fdreg_pc <= 32'h80000000;	// <stdin>:5105:23, Core.scala:33:24
      dereg_op_a <= 64'h0;	// Core.scala:39:24, :432:36
      dereg_op_b <= 64'h0;	// Core.scala:39:24, :432:36
      dereg_reg_waddr <= 5'h0;	// <stdin>:5121:27, Core.scala:39:24
      dereg_branch_type <= 1'h0;	// Core.scala:39:24, :105:24
      dereg_branch_addr <= 64'h0;	// Core.scala:39:24, :432:36
      dereg_alu_op <= 6'h3F;	// <stdin>:5118:27, Core.scala:39:24
      dereg_shamt <= 6'h0;	// <stdin>:5117:23, Core.scala:39:24
      dereg_wb_type <= 2'h0;	// <stdin>:5116:25, Core.scala:39:24
      dereg_sd_type <= 3'h0;	// <stdin>:5084:10, Core.scala:39:24
      dereg_reg2_rdata <= 64'h0;	// Core.scala:39:24, :432:36
      dereg_ld_type <= 3'h0;	// <stdin>:5084:10, Core.scala:39:24
      dereg_csr_t <= 64'h0;	// Core.scala:39:24, :432:36
      dereg_csr_waddr <= 12'h0;	// <stdin>:5111:27, Core.scala:39:24
      dereg_csr_wen <= 1'h0;	// Core.scala:39:24, :105:24
      emreg_reg_wdata <= 64'h0;	// Core.scala:57:24, :432:36
      emreg_reg_waddr <= 5'h0;	// <stdin>:5121:27, Core.scala:57:24
      emreg_wb_type <= 2'h0;	// <stdin>:5116:25, Core.scala:57:24
      emreg_ld_type <= 3'h0;	// <stdin>:5084:10, Core.scala:57:24
      emreg_ld_addr_lowbit <= 3'h0;	// <stdin>:5084:10, Core.scala:57:24
      emreg_csr_wdata <= 64'h0;	// Core.scala:57:24, :432:36
      emreg_csr_wen <= 1'h0;	// Core.scala:57:24, :105:24
      emreg_csr_waddr <= 12'h0;	// <stdin>:5111:27, Core.scala:57:24
      mwreg_reg_wdata <= 64'h0;	// Core.scala:71:24, :432:36
      mwreg_reg_waddr <= 5'h0;	// <stdin>:5121:27, Core.scala:71:24
      mwreg_wb_type <= 2'h0;	// <stdin>:5116:25, Core.scala:71:24
      mwreg_csr_wdata <= 64'h0;	// Core.scala:71:24, :432:36
      mwreg_csr_wen <= 1'h0;	// Core.scala:71:24, :105:24
      mwreg_csr_waddr <= 12'h0;	// <stdin>:5111:27, Core.scala:71:24
    end
    else begin
      ...
      if (_fc_io_fcde_stall) begin	// Core.scala:92:20
        ...
        if (_fc_io_fcde_flush) begin	// Core.scala:92:20
          ...
          dereg_reg_waddr <= 5'h0;	// <stdin>:5121:27, Core.scala:39:24
          dereg_branch_addr <= 64'h0;	// Core.scala:39:24, :432:36
          dereg_alu_op <= 6'h0;	// <stdin>:5117:23, Core.scala:39:24
          dereg_shamt <= 6'h0;	// <stdin>:5117:23, Core.scala:39:24
          dereg_wb_type <= 2'h0;	// <stdin>:5116:25, Core.scala:39:24
          dereg_sd_type <= 3'h0;	// <stdin>:5084:10, Core.scala:39:24
          dereg_reg2_rdata <= 64'h0;	// Core.scala:39:24, :432:36
  ...
  `ifndef SYNTHESIS	// <stdin>:5084:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:5084:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:5084:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:5084:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:5084:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:5084:10
        `INIT_RANDOM_PROLOG_	// <stdin>:5084:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:5084:10
        _RANDOM_0 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_1 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_2 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_3 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_4 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_5 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_6 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_7 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_8 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_9 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_10 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_11 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_12 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_13 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_14 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_15 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_16 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_17 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_18 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_19 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_20 = `RANDOM;	// <stdin>:5084:10
        _RANDOM_21 = `RANDOM;	// <stdin>:5084:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:5084:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:5084:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  Cache Icache (	// Core.scala:104:24
    ...
    .io_cpu_req_bits_inst_type (1'h1),	// <stdin>:5084:10
