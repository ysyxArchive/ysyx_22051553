...
VL_INLINE_OPT void VSoc___024unit____Vdpiimwrap_update_debuginfo_TOP____024unit(IData/*31:0*/ pc, CData/*0:0*/ pc_req, IData/*31:0*/ inst, CData/*0:0*/ inst_valid, CData/*0:0*/ load_use, QData/*63:0*/ op_a, QData/*63:0*/ op_b, QData/*63:0*/ result, CData/*0:0*/ br_yes, CData/*0:0*/ mem_access, QData/*63:0*/ mem_addr, CData/*4:0*/ rd, QData/*63:0*/ reg_wdata, CData/*0:0*/ reg_wen, CData/*0:0*/ csr_wen, QData/*63:0*/ csr_wdata, SData/*11:0*/ csr_waddr, CData/*0:0*/ sdb_stall, CData/*2:0*/ trap_state, CData/*0:0*/ Icache_hit, CData/*0:0*/ Icache_req, CData/*0:0*/ fcfe_stall, CData/*0:0*/ Dcache_hit, CData/*0:0*/ Dcache_req, CData/*0:0*/ fcex_stall) {
    ...
    svLogic Icache_hit__Vcvt;
    for (size_t Icache_hit__Vidx = 0; Icache_hit__Vidx < 1; ++Icache_hit__Vidx) Icache_hit__Vcvt = Icache_hit;
    svLogic Icache_req__Vcvt;
    for (size_t Icache_req__Vidx = 0; Icache_req__Vidx < 1; ++Icache_req__Vidx) Icache_req__Vcvt = Icache_req;
    svLogic fcfe_stall__Vcvt;
    for (size_t fcfe_stall__Vidx = 0; fcfe_stall__Vidx < 1; ++fcfe_stall__Vidx) fcfe_stall__Vcvt = fcfe_stall;
    svLogic Dcache_hit__Vcvt;
    for (size_t Dcache_hit__Vidx = 0; Dcache_hit__Vidx < 1; ++Dcache_hit__Vidx) Dcache_hit__Vcvt = Dcache_hit;
    svLogic Dcache_req__Vcvt;
    for (size_t Dcache_req__Vidx = 0; Dcache_req__Vidx < 1; ++Dcache_req__Vidx) Dcache_req__Vcvt = Dcache_req;
    svLogic fcex_stall__Vcvt;
    for (size_t fcex_stall__Vidx = 0; fcex_stall__Vidx < 1; ++fcex_stall__Vidx) fcex_stall__Vcvt = fcex_stall;
    update_debuginfo(pc__Vcvt, pc_req__Vcvt, inst__Vcvt, inst_valid__Vcvt, load_use__Vcvt, op_a__Vcvt, op_b__Vcvt, result__Vcvt, br_yes__Vcvt, mem_access__Vcvt, mem_addr__Vcvt, rd__Vcvt, reg_wdata__Vcvt, reg_wen__Vcvt, csr_wen__Vcvt, csr_wdata__Vcvt, csr_waddr__Vcvt, sdb_stall__Vcvt, trap_state__Vcvt, Icache_hit__Vcvt, Icache_req__Vcvt, fcfe_stall__Vcvt, Dcache_hit__Vcvt, Dcache_req__Vcvt, fcex_stall__Vcvt);
}
