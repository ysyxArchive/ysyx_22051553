...
VL_INLINE_OPT void VSoc_Cache___nba_sequent__TOP__Soc__DOT__core__DOT__Icache__0(VSoc_Cache* vlSelf) {
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if (vlSelf->__PVT___GEN_0) {
            vlSelf->__PVT__unnamedblk2__DOT___T_1 = 
    ...
    } else if (vlSelf->__PVT__is_idle) {
        if (vlSymsp->TOP.Soc__DOT__core__DOT__fetch__DOT__started) {
            vlSelf->__PVT__state = 1U;
        }
    } else if (vlSelf->__PVT__is_read) {
        vlSelf->__PVT__state = ((IData)(vlSelf->io_fccache_hit)
                                 ? 0U : ((IData)(vlSelf->__PVT__dirty0)
                                          ? 3U : 4U));
    } else if (vlSelf->__PVT__is_write) {
        vlSelf->__PVT__state = ((IData)(vlSelf->__PVT___T_356)
                                 ? 0U : ((IData)(vlSelf->__PVT__dirty0)
                                          ? 3U : 4U));
    } else if (vlSelf->__PVT___T_361) {
        if (vlSymsp->TOP.Soc__DOT__core__DOT___arbitor_io_master2_resp_valid) {
            vlSelf->__PVT__state = 4U;
        }
    } else if (((IData)(vlSelf->__PVT___T_363) & (IData)(vlSymsp->TOP.Soc__DOT__core__DOT___arbitor_io_master2_resp_valid))) {
        vlSelf->__PVT__state = ((0U != (IData)(vlSelf->__PVT__cpu_mask)) 
                                << 1U);
    }
    if (vlSymsp->TOP.Soc__DOT__core__DOT__fetch__DOT__started) {
...
VL_INLINE_OPT void VSoc_Cache___nba_sequent__TOP__Soc__DOT__core__DOT__Dcache__0(VSoc_Cache* vlSelf) {
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if (vlSelf->__PVT__is_idle) {
            if (vlSymsp->TOP.Soc__DOT__core__DOT____Vcellinp__Dcache__io_cpu_req_valid) {
                vlSelf->__PVT__state = ((0U != (IData)(vlSymsp->TOP.Soc__DOT__core__DOT___excute_io_wmask))
                                         ? 2U : 1U);
            }
        } else if (vlSelf->__PVT__is_read) {
            vlSelf->__PVT__state = ((IData)(vlSelf->io_fccache_hit)
        ...
        } else if (((IData)(vlSelf->__PVT___T_363) 
                    & (IData)(vlSymsp->TOP.Soc__DOT__core__DOT___arbitor_io_master1_resp_valid))) {
            vlSelf->__PVT__state = ((0U != (IData)(vlSelf->__PVT__cpu_mask)) 
                                    << 1U);
        }
