...
VL_ATTR_COLD void VSoc___024root__trace_init_sub__TOP__0(VSoc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+76,"io_fwmem_reg_wdata", false,-1, 63,0);
    tracep->declBit(c+78,"io_fwmem_reg_we", false,-1);
    ...
    tracep->declQuad(c+47,"io_fwde_fw_data1", false,-1, 63,0);
    tracep->declQuad(c+49,"io_fwde_fw_data2", false,-1, 63,0);
    tracep->declBit(c+79,"reg1_ex_hazard", false,-1);
    tracep->declBit(c+80,"reg2_ex_hazard", false,-1);
    tracep->declBit(c+81,"reg1_mem_hazard", false,-1);
    tracep->declBit(c+82,"reg2_mem_hazard", false,-1);
    tracep->declBit(c+83,"reg1_wb_hazard", false,-1);
    tracep->declBit(c+84,"reg2_wb_hazard", false,-1);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void VSoc___024root__trace_full_sub_0(VSoc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+55,((((QData)((IData)(__Vtemp_h073bfb9e__0[
                                               (((IData)(0x3fU) 
                                                 + 
                                                 (0xffU 
                                                  & (((0x13U 
    ...
    bufp->fullQData(oldp+76,(vlSelf->Soc__DOT__core__DOT___mem_io_fwmem_reg_wdata),64);
    bufp->fullBit(oldp+78,(vlSelf->Soc__DOT__core__DOT___mem_io_fwmem_reg_we));
    bufp->fullBit(oldp+79,(vlSelf->Soc__DOT__core__DOT__fw__DOT__reg1_ex_hazard));
    bufp->fullBit(oldp+80,(vlSelf->Soc__DOT__core__DOT__fw__DOT__reg2_ex_hazard));
    bufp->fullBit(oldp+81,(vlSelf->Soc__DOT__core__DOT__fw__DOT__reg1_mem_hazard));
    bufp->fullBit(oldp+82,(vlSelf->Soc__DOT__core__DOT__fw__DOT__reg2_mem_hazard));
    bufp->fullBit(oldp+83,(vlSelf->Soc__DOT__core__DOT__fw__DOT__reg1_wb_hazard));
    bufp->fullBit(oldp+84,(vlSelf->Soc__DOT__core__DOT__fw__DOT__reg2_wb_hazard));
