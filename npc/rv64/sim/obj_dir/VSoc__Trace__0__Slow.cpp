...
VL_ATTR_COLD void VSoc___024root__trace_init_sub__TOP__0(VSoc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+23,"clock", false,-1);
    tracep->declBit(c+24,"reset", false,-1);
    tracep->declBit(c+23,"core_clock", false,-1);
    tracep->declBit(c+24,"core_reset", false,-1);
    ...
    tracep->declBit(c+23,"ram_clock", false,-1);
    ...
    tracep->declBit(c+23,"interact_clk", false,-1);
    tracep->declBit(c+23,"fetch_clock", false,-1);
    tracep->declBit(c+24,"fetch_reset", false,-1);
    ...
    tracep->declBus(c+21,"io_dataOut_bits_lo", false,-1, 15,0);
    tracep->declBus(c+22,"io_dataOut_bits_hi", false,-1, 15,0);
    tracep->declBus(c+25,"initvar", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void VSoc___024root__trace_full_sub_0(VSoc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,((((vlSelf->Soc__DOT__ram__DOT__SyncMem
                             ...
                             | ((vlSelf->Soc__DOT__ram__DOT__SyncMem
                                 ...
                                 << 8U) | vlSelf->Soc__DOT__ram__DOT__SyncMem
                                [vlSelf->Soc__DOT__ram__DOT__SyncMem_io_dataOut_bits_MPORT_3_addr_pipe_0]))),32);
    ...
    bufp->fullSData(oldp+21,(((vlSelf->Soc__DOT__ram__DOT__SyncMem
                               [vlSelf->Soc__DOT__ram__DOT__SyncMem_io_dataOut_bits_MPORT_2_addr_pipe_0] 
                               << 8U) | vlSelf->Soc__DOT__ram__DOT__SyncMem
                              [vlSelf->Soc__DOT__ram__DOT__SyncMem_io_dataOut_bits_MPORT_3_addr_pipe_0])),16);
    bufp->fullSData(oldp+22,(((vlSelf->Soc__DOT__ram__DOT__SyncMem
                               [vlSelf->Soc__DOT__ram__DOT__SyncMem_io_dataOut_bits_MPORT_addr_pipe_0] 
                               << 8U) | vlSelf->Soc__DOT__ram__DOT__SyncMem
                              [vlSelf->Soc__DOT__ram__DOT__SyncMem_io_dataOut_bits_MPORT_1_addr_pipe_0])),16);
    bufp->fullBit(oldp+23,(vlSelf->clock));
    bufp->fullBit(oldp+24,(vlSelf->reset));
    bufp->fullIData(oldp+25,(vlSelf->Soc__DOT__ram__DOT__initvar),32);
}
