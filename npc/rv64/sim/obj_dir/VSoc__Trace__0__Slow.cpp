...
VL_ATTR_COLD void VSoc___024root__trace_init_sub__TOP__0(VSoc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+35,"io_rfio_reg1_rdata", false,-1, 63,0);
    tracep->declQuad(c+37,"io_rfio_reg2_rdata", false,-1, 63,0);
    tracep->declBus(c+39,"io_rfio_reg1_raddr", false,-1, 4,0);
    tracep->declBus(c+40,"io_rfio_reg2_raddr", false,-1, 4,0);
    tracep->declQuad(c+41,"io_deio_op_a", false,-1, 63,0);
    tracep->declQuad(c+43,"io_deio_op_b", false,-1, 63,0);
    tracep->declBus(c+45,"io_deio_rd", false,-1, 4,0);
    tracep->declBus(c+46,"io_deio_alu_op", false,-1, 4,0);
    tracep->declBus(c+47,"io_deio_wb_type", false,-1, 1,0);
    tracep->declBus(c+48,"io_deio_sd_type", false,-1, 2,0);
    tracep->declQuad(c+37,"io_deio_reg2_rdata", false,-1, 63,0);
    tracep->declBit(c+49,"io_jump_flag", false,-1);
    tracep->declQuad(c+50,"io_jump_pc", false,-1, 63,0);
    tracep->pushNamePrefix("cu ");
    tracep->declBus(c+1,"io_inst", false,-1, 31,0);
    tracep->declBus(c+52,"io_jump_type", false,-1, 1,0);
    tracep->declBus(c+53,"io_opa_type", false,-1, 1,0);
    tracep->declBus(c+54,"io_opb_type", false,-1, 1,0);
    tracep->declBus(c+55,"io_imm_type", false,-1, 1,0);
    tracep->declBus(c+46,"io_alu_op", false,-1, 4,0);
    tracep->declBus(c+47,"io_wb_type", false,-1, 1,0);
    tracep->declBus(c+48,"io_sd_type", false,-1, 2,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("eximm ");
    tracep->declBus(c+1,"io_inst", false,-1, 31,0);
    tracep->declBus(c+55,"io_imm_type", false,-1, 1,0);
    tracep->declQuad(c+56,"io_eximm", false,-1, 63,0);
    ...
    tracep->declBus(c+58,"io_waddr", false,-1, 31,0);
    tracep->declQuad(c+6,"io_wdata", false,-1, 63,0);
    tracep->declBus(c+8,"io_wmask", false,-1, 7,0);
    ...
    tracep->declBit(c+49,"io_fcde_jump_flag", false,-1);
    tracep->declQuad(c+50,"io_fcde_jump_pc", false,-1, 63,0);
    tracep->declBit(c+49,"io_fcfe_jump_flag", false,-1);
    tracep->declQuad(c+59,"io_fcfe_jump_pc", false,-1, 63,0);
    tracep->declBit(c+49,"io_fcfe_flush", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+29,"io_pc_valid", false,-1);
    tracep->declQuad(c+2,"io_pc_bits", false,-1, 63,0);
    tracep->declBit(c+29,"started", false,-1);
    ...
    tracep->declQuad(c+139,"io_mwio_ld_data", false,-1, 63,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("regfile ");
    tracep->declBit(c+137,"clock", false,-1);
    tracep->declBus(c+39,"io_RfDe_reg1_raddr", false,-1, 4,0);
    tracep->declBus(c+40,"io_RfDe_reg2_raddr", false,-1, 4,0);
    ...
    tracep->declQuad(c+35,"io_RfDe_reg1_rdata", false,-1, 63,0);
    tracep->declQuad(c+37,"io_RfDe_reg2_rdata", false,-1, 63,0);
    ...
    tracep->declBus(c+39,"R1_addr", false,-1, 4,0);
    tracep->declBit(c+143,"R1_en", false,-1);
    tracep->declBit(c+137,"R1_clk", false,-1);
    tracep->declBus(c+40,"R2_addr", false,-1, 4,0);
    ...
    tracep->declQuad(c+27,"io_mwio_ld_data", false,-1, 63,0);
...
VL_ATTR_COLD void VSoc___024root__trace_full_sub_0(VSoc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+4,((QData)((IData)(((0U != (IData)(vlSelf->Soc__DOT__core__DOT__dereg_sd_type))
                                              ? ((0U 
                                                  == (IData)(vlSelf->Soc__DOT__core__DOT__dereg_alu_op))
                                                  ? (IData)(vlSelf->__VdfgTmp_h6424cc69__0)
                                                  : 0U)
                                              : 0U)))),64);
    ...
    bufp->fullQData(oldp+27,(vlSelf->Soc__DOT__core__DOT__mwreg_ld_data),64);
    bufp->fullBit(oldp+29,(vlSelf->Soc__DOT__core__DOT__fetch__DOT__started));
    bufp->fullQData(oldp+30,(((0U == (IData)(vlSelf->Soc__DOT__core__DOT__dereg_alu_op))
    ...
    bufp->fullQData(oldp+35,(vlSelf->Soc__DOT__core__DOT___regfile_io_RfDe_reg1_rdata),64);
    bufp->fullQData(oldp+37,(vlSelf->Soc__DOT__core__DOT___regfile_io_RfDe_reg2_rdata),64);
    bufp->fullCData(oldp+39,((0x1fU & (vlSelf->Soc__DOT___tm_inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+40,((0x1fU & (vlSelf->Soc__DOT___tm_inst 
                                       >> 0x14U))),5);
    bufp->fullQData(oldp+41,(((2U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opa_type))
    ...
    bufp->fullQData(oldp+43,((((QData)((IData)(__Vtemp_h1de70962__0[
                                               (((IData)(0x3fU) 
                                                 + 
                                                 (0xffU 
                                                  & (((0x13U 
                                                  ...
                                                  ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_h73d7e1c7__0)
                                                   ...
                                                   ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_0)
                                                    ...
                                                    (0x1a3U 
                                                     == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN))))) 
                                                 << 6U)))))),64);
    bufp->fullCData(oldp+45,((0x1fU & (vlSelf->Soc__DOT___tm_inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+46,((0x1fU & (- (IData)((1U 
                                                  & ((~ 
    ...
    bufp->fullCData(oldp+47,(((0x13U == vlSelf->Soc__DOT___tm_inst)
                               ? 0U : ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_hbf1f1a09__0)
                                        ? 1U : ((0x1a3U 
                                                 == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)) 
                                                << 1U)))),2);
    bufp->fullCData(oldp+48,((((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_ha79e1490__0) 
                               | (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_0))
                               ? 0U : ((0x1a3U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)) 
                                       << 2U))),3);
    bufp->fullBit(oldp+49,(vlSelf->Soc__DOT__core__DOT___fc_io_fcfe_jump_flag));
    bufp->fullQData(oldp+50,(((1U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type))
                               ...
                               : ((2U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type))
                                   ? (0xfffffffffffffffeULL 
                                      & (vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm 
                                         + vlSelf->Soc__DOT__core__DOT___regfile_io_RfDe_reg1_rdata))
                                   : 0x80000000ULL))),64);
    bufp->fullCData(oldp+52,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type),2);
    bufp->fullCData(oldp+53,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opa_type),2);
    bufp->fullCData(oldp+54,(((0x13U == vlSelf->Soc__DOT___tm_inst)
    ...
    bufp->fullCData(oldp+55,(((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_hd7167e15__0)
                                                ...
                                                ((0x67U 
                                                 ...
                                                 (3U 
                                                  & (- (IData)(
                                                               (0x1a3U 
                                                                == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)))))))))),2);
    bufp->fullQData(oldp+56,(vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm),64);
    bufp->fullIData(oldp+58,(((0U != (IData)(vlSelf->Soc__DOT__core__DOT__dereg_sd_type))
