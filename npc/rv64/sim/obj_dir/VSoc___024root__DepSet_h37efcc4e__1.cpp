...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4674, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 4674, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4674, "", "NBA region did not converge.");
            }
