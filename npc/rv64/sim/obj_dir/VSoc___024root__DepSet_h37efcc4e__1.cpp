...
VL_INLINE_OPT void VSoc___024root___nba_sequent__TOP__4(VSoc___024root* vlSelf) {
    ...
    vlSelf->Soc__DOT___core_io_AXI_Interface_ar_bits_addr 
        = ((1U & ((~ ((2U == (IData)(vlSelf->Soc__DOT__core__DOT__arbitor__DOT__state)) 
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4672, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 4672, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4672, "", "NBA region did not converge.");
            }
