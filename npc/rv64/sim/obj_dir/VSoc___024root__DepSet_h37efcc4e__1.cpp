...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4652, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 4652, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4652, "", "NBA region did not converge.");
            }
