...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4608, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 4608, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4608, "", "NBA region did not converge.");
            }
