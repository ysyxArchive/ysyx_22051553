...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4640, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 4640, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4640, "", "NBA region did not converge.");
            }
