...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4648, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 4648, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 4648, "", "NBA region did not converge.");
            }
