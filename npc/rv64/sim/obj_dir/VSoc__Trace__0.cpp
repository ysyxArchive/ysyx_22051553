...
void VSoc___024root__trace_chg_sub_0(VSoc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgQData(oldp+22,(((0U == (IData)(vlSelf->Soc__DOT__core__DOT__dereg_alu_op))
                                  ? (vlSelf->Soc__DOT__core__DOT__dereg_op_a 
                                     + vlSelf->Soc__DOT__core__DOT__dereg_op_b)
                                  : 0ULL)),64);
        bufp->chgBit(oldp+24,((0U != (IData)(vlSelf->Soc__DOT__core__DOT__mwreg_wb_type))));
        bufp->chgQData(oldp+25,((((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid) 
                                 ...
                                 [((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                    ...
                                    : 0U)] : 0ULL)),64);
        bufp->chgQData(oldp+27,((((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid) 
                                 ...
                                 [((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                    ? ((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                        ...
                                        : 0U) : 0U)]
                                  : 0ULL)),64);
        bufp->chgCData(oldp+29,(((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                  ? (IData)(vlSelf->__VdfgTmp_h049a0a75__0)
                                  : 0U)),5);
        bufp->chgCData(oldp+30,(((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                  ? ((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                      ? (0x1fU & (vlSelf->__VdfgTmp_h27324541__0 
                                                  >> 0x14U))
                                      : 0U) : 0U)),5);
        bufp->chgQData(oldp+31,((((0x13U != vlSelf->Soc__DOT__core__DOT__decode__DOT___inst_T) 
                                  ...
                                  : 0ULL)),64);
        bufp->chgQData(oldp+33,(((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opb_type)
                                  ? vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm
                                  : 0ULL)),64);
        bufp->chgCData(oldp+35,(((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                  ? ((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                      ? (0x1fU & ((IData)(vlSelf->__VdfgTmp_h50f8190e__0) 
                                                  >> 7U))
                                      : 0U) : 0U)),5);
        bufp->chgCData(oldp+36,((0x1fU & (- (IData)(
                                                    (1U 
                                                     & ((~ (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_0)) 
                                                        | (0x13U 
                                                           == vlSelf->Soc__DOT__core__DOT__decode__DOT___inst_T))))))),5);
        bufp->chgCData(oldp+37,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opb_type),2);
        bufp->chgBit(oldp+38,(vlSelf->Soc__DOT__core__DOT___fc_io_fcfe_jump_flag));
        bufp->chgQData(oldp+39,(((1U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type))
                                  ? (vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm 
                                     + vlSelf->Soc__DOT__core__DOT__fdreg_pc)
                                         ...
                                         & (vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm 
                                            + (((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid) 
                                               ...
                                               [((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                                ...
                                                : 0ULL)))
                                      : 0x80000000ULL))),64);
        bufp->chgIData(oldp+41,(vlSelf->Soc__DOT__core__DOT__decode__DOT___inst_T),32);
        bufp->chgCData(oldp+42,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type),2);
        bufp->chgBit(oldp+43,(((0x13U != vlSelf->Soc__DOT__core__DOT__decode__DOT___inst_T) 
                               & ((0x13U != (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)) 
                                  & ((0x17U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_h1fd6a75a__0)) 
                                     | ((0x37U != (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_h1fd6a75a__0)) 
                                        & (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_h5d4f4c30__0)))))));
        bufp->chgBit(oldp+44,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opb_type));
        bufp->chgCData(oldp+45,(((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_hd7167e15__0)
                                  ? 0U : ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_h86e6c972__0)
                                           ? 1U : (
                                                   ...
                                                   << 1U)))),2);
        bufp->chgQData(oldp+46,(vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm),64);
        bufp->chgQData(oldp+48,(vlSelf->Soc__DOT__core__DOT___fc_io_fcfe_jump_pc),64);
        bufp->chgQData(oldp+50,(vlSelf->Soc__DOT__core__DOT__fetch__DOT__pc),64);
        bufp->chgIData(oldp+52,(((IData)(vlSelf->Soc__DOT__ram__DOT__inst_valid)
                                  ? vlSelf->Soc__DOT___ram_io_dataOut_bits
                                  : 0U)),32);
        bufp->chgBit(oldp+53,(vlSelf->Soc__DOT__core__DOT__interact__DOT__ebreak_flag));
        bufp->chgCData(oldp+54,(vlSelf->Soc__DOT__core__DOT__interact__DOT__over_count),3);
