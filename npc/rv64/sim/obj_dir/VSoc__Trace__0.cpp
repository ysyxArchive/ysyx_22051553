...
void VSoc___024root__trace_chg_sub_0(VSoc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+65,(((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_9)
                                                   ...
                                                   ((0xa3U 
                                                    ...
                                                    ((0x123U 
                                                     ...
                                                     ((0x1a3U 
                                                       == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)) 
                                                      << 2U))))))),3);
        bufp->chgCData(oldp+66,(((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_9)
        ...
        bufp->chgCData(oldp+74,(((0U != (IData)(vlSelf->Soc__DOT__core__DOT__dereg_ld_type))
                                  ...
                                  : 0U)),3);
        bufp->chgBit(oldp+75,(vlSelf->Soc__DOT__core__DOT___excute_io_jump_flag));
        bufp->chgBit(oldp+76,((1U == (IData)(vlSelf->Soc__DOT__core__DOT__dereg_wb_type))));
        bufp->chgBit(oldp+77,(((IData)(vlSelf->Soc__DOT__core__DOT___fc_io_fcfe_flush) 
