...
void VSoc___024root__trace_chg_sub_0(VSoc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgQData(oldp+3,((QData)((IData)(((0U 
        ...
        bufp->chgQData(oldp+26,(vlSelf->Soc__DOT__core__DOT__mwreg_ld_data),64);
        bufp->chgBit(oldp+28,(vlSelf->Soc__DOT__core__DOT__fetch__DOT__started));
        bufp->chgQData(oldp+29,(((0U == (IData)(vlSelf->Soc__DOT__core__DOT__dereg_alu_op))
        ...
        bufp->chgQData(oldp+34,(vlSelf->Soc__DOT__core__DOT___regfile_io_RfDe_reg1_rdata),64);
        bufp->chgQData(oldp+36,(vlSelf->Soc__DOT__core__DOT___regfile_io_RfDe_reg2_rdata),64);
        bufp->chgCData(oldp+38,((0x1fU & (vlSelf->Soc__DOT___tm_inst 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+39,((0x1fU & (vlSelf->Soc__DOT___tm_inst 
                                          >> 0x14U))),5);
        bufp->chgQData(oldp+40,(((2U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opa_type))
        ...
        bufp->chgQData(oldp+42,((((QData)((IData)(__Vtemp_h1de70962__0[
                                                  (((IData)(0x3fU) 
                                                    + 
                                                    (0xffU 
                                                     & (((0x13U 
                                             ...
                                             ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_h73d7e1c7__0)
                                               ...
                                               : ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_0)
                                                  ...
                                                  (0x1a3U 
                                                   == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN))))) 
                                            << 6U)))))),64);
        bufp->chgCData(oldp+44,((0x1fU & (vlSelf->Soc__DOT___tm_inst 
                                          >> 7U))),5);
        bufp->chgCData(oldp+45,((0x1fU & (- (IData)(
                                                    (1U 
                                                     & ((~ 
        ...
        bufp->chgCData(oldp+46,(((0x13U == vlSelf->Soc__DOT___tm_inst)
                                  ? 0U : ((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_hbf1f1a09__0)
                                           ? 1U : (
                                                   (0x1a3U 
                                                    == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)) 
                                                   << 1U)))),2);
        bufp->chgCData(oldp+47,((((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_ha79e1490__0) 
                                  | (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN_0))
                                  ? 0U : ((0x1a3U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)) 
                                          << 2U))),3);
        bufp->chgBit(oldp+48,(vlSelf->Soc__DOT__core__DOT___fc_io_fcfe_jump_flag));
        bufp->chgQData(oldp+49,(((1U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type))
                                  ...
                                  : ((2U == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type))
                                      ? (0xfffffffffffffffeULL 
                                         & (vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm 
                                            + vlSelf->Soc__DOT__core__DOT___regfile_io_RfDe_reg1_rdata))
                                      : 0x80000000ULL))),64);
        bufp->chgCData(oldp+51,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_jump_type),2);
        bufp->chgCData(oldp+52,(vlSelf->Soc__DOT__core__DOT__decode__DOT___cu_io_opa_type),2);
        bufp->chgCData(oldp+53,(((0x13U == vlSelf->Soc__DOT___tm_inst)
        ...
        bufp->chgCData(oldp+54,(((IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT____VdfgTmp_hd7167e15__0)
                                                   ...
                                                   ((0x67U 
                                                    ...
                                                    (3U 
                                                     & (- (IData)(
                                                                  (0x1a3U 
                                                                   == (IData)(vlSelf->Soc__DOT__core__DOT__decode__DOT__cu__DOT___GEN)))))))))),2);
        bufp->chgQData(oldp+55,(vlSelf->Soc__DOT__core__DOT__decode__DOT___eximm_io_eximm),64);
        bufp->chgIData(oldp+57,(((0U != (IData)(vlSelf->Soc__DOT__core__DOT__dereg_sd_type))
