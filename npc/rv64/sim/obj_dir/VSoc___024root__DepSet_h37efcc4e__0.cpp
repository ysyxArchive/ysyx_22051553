...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8555, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8555, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8555, "", "NBA region did not converge.");
            }
