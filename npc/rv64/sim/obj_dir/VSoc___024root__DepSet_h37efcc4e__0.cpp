...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3006, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3006, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3006, "", "NBA region did not converge.");
            }
