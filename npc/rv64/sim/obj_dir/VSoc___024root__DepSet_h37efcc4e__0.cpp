...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6843, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6843, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6843, "", "NBA region did not converge.");
            }
