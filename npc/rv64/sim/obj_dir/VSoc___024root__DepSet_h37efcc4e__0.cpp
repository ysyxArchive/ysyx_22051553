...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6844, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6844, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6844, "", "NBA region did not converge.");
            }
