...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3049, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3049, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3049, "", "NBA region did not converge.");
            }
