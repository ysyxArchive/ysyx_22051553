...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6912, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6912, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6912, "", "NBA region did not converge.");
            }
