...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9559, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9559, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9559, "", "NBA region did not converge.");
            }
