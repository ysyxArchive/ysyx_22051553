...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8567, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8567, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8567, "", "NBA region did not converge.");
            }
