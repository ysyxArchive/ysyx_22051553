...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9736, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9736, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9736, "", "NBA region did not converge.");
            }
