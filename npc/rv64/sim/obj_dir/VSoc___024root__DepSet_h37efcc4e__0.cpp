...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8503, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8503, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8503, "", "NBA region did not converge.");
            }
