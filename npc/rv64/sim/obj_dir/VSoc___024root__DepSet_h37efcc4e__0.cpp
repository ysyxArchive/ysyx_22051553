...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6858, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6858, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6858, "", "NBA region did not converge.");
            }
