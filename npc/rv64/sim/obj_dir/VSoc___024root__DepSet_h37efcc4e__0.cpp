...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9839, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9839, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9839, "", "NBA region did not converge.");
            }
