...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6853, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6853, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6853, "", "NBA region did not converge.");
            }
