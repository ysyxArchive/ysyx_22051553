...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6911, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6911, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6911, "", "NBA region did not converge.");
            }
