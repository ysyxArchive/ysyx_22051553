...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9845, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9845, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9845, "", "NBA region did not converge.");
            }
