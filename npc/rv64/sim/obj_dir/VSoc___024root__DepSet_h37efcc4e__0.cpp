...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3005, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3005, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3005, "", "NBA region did not converge.");
            }
