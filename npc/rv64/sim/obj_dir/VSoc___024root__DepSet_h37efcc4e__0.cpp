...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6913, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6913, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6913, "", "NBA region did not converge.");
            }
