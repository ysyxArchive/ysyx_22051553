...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9534, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9534, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9534, "", "NBA region did not converge.");
            }
