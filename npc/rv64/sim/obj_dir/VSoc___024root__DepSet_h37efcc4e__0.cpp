...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9595, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9595, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9595, "", "NBA region did not converge.");
            }
