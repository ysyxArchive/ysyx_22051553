...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9544, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9544, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9544, "", "NBA region did not converge.");
            }
