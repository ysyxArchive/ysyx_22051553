...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8487, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8487, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8487, "", "NBA region did not converge.");
            }
