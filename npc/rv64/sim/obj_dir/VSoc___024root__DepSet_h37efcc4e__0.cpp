...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9569, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9569, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9569, "", "NBA region did not converge.");
            }
