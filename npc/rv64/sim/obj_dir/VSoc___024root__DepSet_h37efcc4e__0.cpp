...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8485, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8485, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8485, "", "NBA region did not converge.");
            }
