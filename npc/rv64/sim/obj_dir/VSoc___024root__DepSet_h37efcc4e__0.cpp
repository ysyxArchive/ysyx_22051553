...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9583, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9583, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9583, "", "NBA region did not converge.");
            }
