...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8537, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8537, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8537, "", "NBA region did not converge.");
            }
