...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9563, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9563, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9563, "", "NBA region did not converge.");
            }
