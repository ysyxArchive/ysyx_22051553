...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3654, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3654, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3654, "", "NBA region did not converge.");
            }
