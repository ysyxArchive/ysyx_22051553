...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9571, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9571, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9571, "", "NBA region did not converge.");
            }
