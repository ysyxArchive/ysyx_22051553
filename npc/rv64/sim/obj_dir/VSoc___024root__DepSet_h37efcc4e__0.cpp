...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6840, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6840, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6840, "", "NBA region did not converge.");
            }
