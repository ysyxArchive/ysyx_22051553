...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8552, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8552, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8552, "", "NBA region did not converge.");
            }
