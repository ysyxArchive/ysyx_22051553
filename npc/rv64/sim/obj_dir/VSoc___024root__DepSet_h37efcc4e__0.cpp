...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8530, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8530, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8530, "", "NBA region did not converge.");
            }
