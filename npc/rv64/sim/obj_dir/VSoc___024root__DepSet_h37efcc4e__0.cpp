...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9754, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9754, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9754, "", "NBA region did not converge.");
            }
