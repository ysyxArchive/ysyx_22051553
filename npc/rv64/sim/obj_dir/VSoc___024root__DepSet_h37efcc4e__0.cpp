...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6823, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6823, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6823, "", "NBA region did not converge.");
            }
