...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9575, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9575, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9575, "", "NBA region did not converge.");
            }
