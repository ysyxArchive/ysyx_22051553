...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8553, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8553, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8553, "", "NBA region did not converge.");
            }
