...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9565, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9565, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9565, "", "NBA region did not converge.");
            }
