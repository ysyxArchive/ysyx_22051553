...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9564, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9564, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9564, "", "NBA region did not converge.");
            }
