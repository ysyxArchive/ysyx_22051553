...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8508, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8508, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8508, "", "NBA region did not converge.");
            }
