...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6842, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6842, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6842, "", "NBA region did not converge.");
            }
