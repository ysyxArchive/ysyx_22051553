...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9841, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9841, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9841, "", "NBA region did not converge.");
            }
