...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8546, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8546, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8546, "", "NBA region did not converge.");
            }
