...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8504, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8504, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8504, "", "NBA region did not converge.");
            }
