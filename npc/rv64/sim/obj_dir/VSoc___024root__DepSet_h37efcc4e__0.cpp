...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8549, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8549, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8549, "", "NBA region did not converge.");
            }
