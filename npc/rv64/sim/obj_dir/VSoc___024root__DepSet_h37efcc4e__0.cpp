...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9540, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9540, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9540, "", "NBA region did not converge.");
            }
