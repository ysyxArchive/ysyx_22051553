...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6825, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6825, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6825, "", "NBA region did not converge.");
            }
