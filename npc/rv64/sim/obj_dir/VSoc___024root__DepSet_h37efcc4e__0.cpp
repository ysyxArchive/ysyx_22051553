...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9530, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9530, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9530, "", "NBA region did not converge.");
            }
