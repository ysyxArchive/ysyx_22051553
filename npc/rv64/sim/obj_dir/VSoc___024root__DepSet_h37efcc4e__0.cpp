...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 12655, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 12655, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 12655, "", "NBA region did not converge.");
            }
