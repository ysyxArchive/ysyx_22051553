...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6850, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6850, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6850, "", "NBA region did not converge.");
            }
