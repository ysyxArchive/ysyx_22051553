...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9834, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 9834, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 9834, "", "NBA region did not converge.");
            }
