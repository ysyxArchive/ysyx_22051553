...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6838, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 6838, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 6838, "", "NBA region did not converge.");
            }
