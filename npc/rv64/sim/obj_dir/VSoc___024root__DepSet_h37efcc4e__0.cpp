...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3224, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3224, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3224, "", "NBA region did not converge.");
            }
