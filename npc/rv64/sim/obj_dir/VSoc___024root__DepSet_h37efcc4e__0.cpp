...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8535, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8535, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8535, "", "NBA region did not converge.");
            }
