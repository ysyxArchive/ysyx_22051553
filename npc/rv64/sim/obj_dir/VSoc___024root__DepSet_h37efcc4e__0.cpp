...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3010, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3010, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3010, "", "NBA region did not converge.");
            }
