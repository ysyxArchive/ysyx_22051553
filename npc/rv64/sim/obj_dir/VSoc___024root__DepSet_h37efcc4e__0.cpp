...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3027, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3027, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3027, "", "NBA region did not converge.");
            }
