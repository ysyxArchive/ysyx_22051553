...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3081, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3081, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3081, "", "NBA region did not converge.");
            }
