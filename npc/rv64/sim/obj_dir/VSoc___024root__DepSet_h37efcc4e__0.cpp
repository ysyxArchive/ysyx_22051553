...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8557, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8557, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8557, "", "NBA region did not converge.");
            }
