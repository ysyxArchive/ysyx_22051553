...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8547, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8547, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8547, "", "NBA region did not converge.");
            }
