...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3489, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3489, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3489, "", "NBA region did not converge.");
            }
