...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3000, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 3000, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 3000, "", "NBA region did not converge.");
            }
