...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8486, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8486, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8486, "", "NBA region did not converge.");
            }
