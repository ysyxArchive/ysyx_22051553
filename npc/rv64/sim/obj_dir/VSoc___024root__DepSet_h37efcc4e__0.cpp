...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8542, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Soc.v", 8542, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Soc.v", 8542, "", "NBA region did not converge.");
            }
