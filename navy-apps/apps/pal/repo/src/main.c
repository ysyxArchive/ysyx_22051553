...
--*/
{
   ...
   // //-----------自添加
   // buf = (LPBYTE)UTIL_calloc(1, 320 * 200 * 2 + 8); //用于对齐
   ...
   //    buf_off ++;
   // }
   // buf2 = (LPBYTE)(buf_off + 320 * 200);
   // Decompress(buf_off, buf2, 320 * 200);
   ...
   //    buf_off ++;
   // }
   // Decompress(buf_off, lpSpriteCrane, 32000);
